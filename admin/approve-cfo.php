                    ...
                    <div class="portlet">
						...
						Grupos aprobación de programación
                            ...
                            <div class="actions">
                                 ...
                                 <a href="approve-cfo-group.php" class="btn default blue-stripe" target="_blank">
...
<div class="table-scrollable">
                                ...
                                <tr role="row" class="odd"> 
								  ...
								  $rowbank = mysqli_fetch_array($resultbank); echo $rowbank['name']; ?>/<?php echo $row['code']; ?></td> 
                                  <td><?php echo $rowuser['first']." ".$rowuser['last']; ?></td>
                                  <td><?php echo date('d-m-Y',strtotime($row['today'])); ?><br>
<?php echo date('h:i:s a', strtotime($row['now2'])); ?>
                                    
</td><td><?php 

$queryschedullet = "select * from scheduletimes where schedule = '$row[id]' and stage = '3' limit 1";
$resultschedullet = mysqli_query($con, $queryschedullet);
$rowschedullet = mysqli_fetch_array($resultschedullet);

echo date('d-m-Y',strtotime($rowschedullet['today'])); ?><br>
<?php echo date('h:i:s a', strtotime($rowschedullet['now2'])); ?></td>
							...
							</td><td><a href="approve-cfo-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
