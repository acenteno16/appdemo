...
<span style="font-size:16px; font-wigth:bold;">Cliente: <?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; 
								echo $ben_name; ?>
                                  <br>
...
//2nd process
$querybefore2 = "select payments.* from payments inner join workers on payments.userid = workers.code where payments.approved = '0' and payments.type != '4'".$sqlu." and payments.userid = '$rowbefore1[userid]' order by payments.expiration asc"; 
...
$globalpaymentsnumber = $globalpaymentsnumber+$numbefore2;
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								$querybefore = "select payments.* from payments inner join workers on payments.userid = workers.code inner join times on payments.id = times.payment where payments.approved = '0' and payments.type != '4'".$sqlu.$sql." group by payments.userid order by payments.expiration desc"; 
	 ...
	 var checkall = document.getElementById('checkall_'+cki);
      ...
      <th width="15%">
							 ...
							 Información General</th>
                                ...
                                <td>ID: <?php echo $row['id']; ?><br>
<span style="font-size:16px; font-wigth:bold;">Beneficiario: <?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; echo $ben_name; 
								?>
                                  <br>
                                  Monto:<?php $querycurrency = "select * from currency where id = '$row[currency]'";
								$resultcurrency = mysqli_query($con, $querycurrency);
