...
?>
													 ...
													 <h3>Informacion del <?php echo $beneficiarytype; ?></h3>
                                                      <p><? echo $ben_name; /*<strong>Nombre:</strong> <?php echo $beneficiaryname; ?><br>
...
?>
                                ...
                                <tr role="row" class="odd">
                                  <td class="sorting_1">
									  <? $fileURL = 'visor.php?key='.$url; ?>
									  
									  <a href="<? echo $fileURL; ?>"><?php echo '<strong>'.$rowpayment['id'].'</a>';

?></a><a href="<? echo $fileURL; ?>"> </a></td>
                                  <td><a href="<? echo $fileURL; ?>"> <?php echo '<strong>'.ucfirst($thetitle).'</strong></a>';

?></a></td>
                                  <td><a href="<? echo $fileURL; ?>" target="_blank">  
