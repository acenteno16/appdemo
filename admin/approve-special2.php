            ...
            <div class="col-md-12"><!-- Begin: life time stats -->
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							//1st process
$querybefore1 = "select payments.* from payments inner join workers on payments.userid = workers.code inner join times on payments.id = times.payment where payments.approved = '0'".$sqlu." group by payments.userid order by payments.expiration desc"; 
...
//2nd process
$querybefore2 = "select payments.* from payments inner join workers on payments.userid = workers.code where payments.approved = 0".$sqlu." and payments.userid = '$rowbefore1[userid]' order by payments.expiration asc"; 
...
$sql = $sql1.$sql2.$sql3.$sql4;				
								...
								$querybefore = "select payments.* from payments inner join workers on payments.userid = workers.code inner join times on payments.id = times.payment where payments.approved = '0'".$sqlu.$sql." group by payments.userid order by payments.expiration desc"; 
								...
								while($rowbefore=mysqli_fetch_array($resultbefore)){
									$rowworker = mysqli_fetch_array(mysqli_query($con, "select * from workers where code = '$rowbefore[userid]'"));
								...
								$querythisunit = "select * from units where code = '$rowworker[unit]'";
...
<br>
								...
								<tr role="row" class="heading">
									...
									<th width="2%">
										 ...
										 <input type="checkbox" class="group-checkable" id="checkall2" onChange="javascript:checkAll2();" checked="checked" />  
	 ...
	 var checkall = document.getElementById('checkall2');
      ...
      <th width="15%">
							 ...
							 Información General</th>
								...
								<tbody>
                                <?php //2
								$query = "select payments.* from payments inner join workers on payments.userid = workers.code where payments.approved = 0".$sqlu." and payments.userid = '$rowbefore[userid]' order by payments.expiration asc"; 
                                ...
                                <tr role="row" class="odd">
                                  <td class="sorting_1"> <input name="id[]" type="checkbox" class="approve2" id="id[]" value="<?php echo $row['id']; ?>" checked></td>
                                <td>ID:<?php echo $row['id']; ?><br>
<span style="font-size:16px; font-wigth:bold;">Proveedor: <?php echo $rowprovider['code']; ?> | <?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; 
