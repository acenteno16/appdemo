					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="available-balance-credit.php?currency=1" class="btn default blue-stripe">
...
<a href="available-balance-debit.php?currency=1" class="btn default blue-stripe">
...
<div class="col-md-3 " style="left:-15px;">
                       ...
                       <!--/row-->
								...
								<tbody>
                               <?php $transactions = $_GET['transactions'];
							   $sql = " ";
							   if($transactions == 1){
								   $sql = " and type = 'nc' ";
							   }
							   ...
							   $query = "select * from balance where currency = '1'".$sql."order by id desc";
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="available-balance-credit.php?currency=2" class="btn default blue-stripe">
...
<a href="available-balance-debit.php?currency=2" class="btn default blue-stripe">
...
<div class="col-md-3 " style="left:-15px;">
                       ...
                       <!--/row-->
							   ...
							   $query = "select * from balance where currency = '2'".$sql."order by id desc";
							   $result = mysqli_query($con, $query);
							   while($row=mysqli_fetch_array($result)){
							   ?> 
                                <tr role="row" class="odd">
