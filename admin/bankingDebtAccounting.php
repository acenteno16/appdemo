		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Contabilizacion de Deuda bancaria <? //<small>Solicitudes de pago</small> ?>
...
$query = "select * from bankingDebt where userid = '$_SESSION[userid]' order by id desc";
$result = mysqli_query($con, $query);
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);

$query1 = "select * from bankingDebt where userid = '$_SESSION[userid]' order by id desc limit ".$inicio.",".$tampagina;  
    ...
    while($rowbanks=mysqli_fetch_array($resultbanks)){
        $theBank["$rowbanks[id]"] = $rowbanks['name'];
				...
				while($row=mysqli_fetch_array($result1)){
                                ...
                                <td><? echo $row['lNumber']; ?></td>
                                <td>-</td>
								<td>-</td>
								<td>-</td>
								<td>
									<a href="bankingDebtAccountingView.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Contabilizar</a>
                            	</td></tr>
                                <?php }
