		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Liquidaciones <small>Liquidación de pagos</small> 
...
$query = "select payments.* from payments inner join workers on payments.userid = workers.code where payments.child='0' and (payments.status = '2' or payments.status = '3' or payments.status = '4') and payments.approved = '1' and payments.type= '4'".$sqlu." order by payments.expiration asc"; 
                    ...
                    <div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								...
								<? echo $num; ?> Liquidaciones de pagos pendientes</div>
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								echo $queryupdate = "update payments set credit = '1' where id = '$row[id]'";
