...
while($rowvobo=mysqli_fetch_array($resultvobo)){
	...
	if($numuvobo > 0 ){
		...
		$querybefore1vobo = "select payments.* from payments inner join workers on payments.userid = workers.code where payments.status = '1' and payments.approved = '0' and payments.arequest = '0'".$sqluvobo." order by payments.expiration desc"; 
...
$message = '<!doctype html>  
		...
		$mail->addAddress($workeremail2, $workername2);
