...
$query_main = "select id, btype, provider, collaborator, intern, client from payments where cnotification = '1' and btype = '1'"; 
...
foreach ($providers as $beneficiary => $payments) {
	...
	$mail->addBCC('getpay.retenciones@gmail.com');                                   // Set email format to HTML
