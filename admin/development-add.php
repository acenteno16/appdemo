...
<div class="page-container">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>Agregar nuevo requerimiento
								...
								<div class="portlet box blue">
									...
									<div class="portlet-title">
			 						...
			 						<div class="portlet-body form">
										...
										<form action="development-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers"> 
	...
	<label class="control-label">Fecha forzada:</label>
	<input name="today2" type="text" class="form-control date-picker" id="today2" value="" readonly>
	<div title="Page 5">
															  <div>
															    <div>
	...
	<label class="control-label">Hora forzada:</label>
	<input name="totime2" type="text" class="form-control timepicker" id="totime2" value="" >
	<div title="Page 5">
															  <div>
															    <div>
...
<input type="checkbox" class="group-checkable" id="checkall" onChange="javascript:checkAll();" /> Todos los perfiles
  ...
  $resto = ($i % $numcolumnas);  
	...
	<label class="control-label">Asignar a:</label>
											...
											<select name="userid2" class="form-control  select2me" id="userid2" data-placeholder="Seleccionar..." onChange="javascript:reloadNumbers(),validateBill();"> 
                                           

											  <option value=""></option>
<?php $queryproviders = "select * from workers";
$resultproviders = mysqli_query($con, $queryproviders);
while($rowproviders=mysqli_fetch_array($resultproviders)){
?>
												<option value="<?php echo $rowproviders['code']; ?>"<?php if($rowpconfirm['provider'] == $rowproviders['id']) echo 'selected'; ?>><?php echo $rowproviders['code']." | ".$rowproviders['first']." ".$rowproviders['last']; ?></option>
                                                <?php } ?>
