				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li><a href="file-management.php">Almacenamiento de remisiones</a>
							<i class="fa fa-angle-right"></i>
						</li>
...
echo number_format($numdev);								
				...
				Pendientes de Almacenar.
							...
							<div class="actions">
								<a href="file-management-report-excel.php" class="btn default blue-stripe">
...
$query1 = "select * from schedule where status = '6' order by id desc limit ".$inicio.",".$tampagina; 
...
?>
                 ...
                 <li>
										<a href="file-management-report.php?page=<?php echo $previous; ?>">
  ...
  for ($i=1;$i<=$totpagina;$i++){ 
        if ($pagina == $i){
		  ...
		  echo '<li><a href="file-management-report.php?page='.$i .'">'.$i .'</a></li>'; 
		}
    } } ?>
             <?php if($next != ""){ ?>
                 ...
                 <li>
										<a href="file-management-report.php?page=<?php echo $next; ?>);">
										<i class="fa fa-angle-right"></i>
										</a>
									</li>
                  <?php } ?>
