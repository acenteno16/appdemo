...
$queryreview = "select * from filereview where payment = '$id'";
 ...
 <strong>No. de archivos:</strong> <?php echo $numfiles; ?> <br>
				...
				LOG del paquete
						...
						<div class="portlet-body">
							...
							<?php $querylog = "select * from senttimes where package = '$_GET[id]' order by id desc";
								...
								?>
                                	...
                                	<p><strong>TID:</strong> ID de la transacción</p>
                                ...
                                <td> <?php echo date('h:i:s a', strtotime($rowlog['now2']));?> </td>
                                <td><?php $queryworker = "select * from workers where code = '$rowlog[userid]'";
								$resultworker = mysqli_query($con, $queryworker);
								$rowworker = mysqli_fetch_array($resultworker);
								echo $rowworker['first']." ".$rowworker['last'];
						...
						<div class="portlet-body">
							...
							<?php $queryfile = "select * from files where payment = '$_GET[id]'";
							  ...
							  <table class="table table-striped table-bordered table-hover" id="datatable_orders">
								...
								?>
                                <tr role="row" class="odd <?php switch($rowreview['aorder']){ 
								case 0:
								echo 'danger';
								break;
								case 1:
                                ...
                                <td><a href="<?php echo cleanURL($rowfile['link']); ?>" class="btn btn-xs default btn-editable" target="new"><i class="fa fa-link"></i> <?php echo cleanURL($rowfile['link']); ?></a> </td>
                                </tr>
                                    <?php } ?>
                                                                </tbody>
                              ...
                              <h3>Provision</h3>
                                ...
                                <?php 
								$queryfile = "select * from batch where payment = '$_GET[id]'";
 $resultfile = mysqli_query($con, $queryfile);
								...
								?>
                                <tr role="row" class="odd <?php switch($rowreview['aprovision']){ 
								case 0:
								echo 'danger';
								break;
								case 1:
                                ...
                                <td><?php if($rowfile['nobatch'] != "") echo 'Batch No. '.$rowfile['nobatch']; else echo "Archivo sin nombre."; ?></td>
                                <td><a href="<?php echo cleanURL($rowfile['linkdocument']); ?>" class="btn btn-xs default btn-editable" target="new"><i class="fa fa-link"></i> <?php echo cleanURL($rowfile['linkdocument']); ?></a> </td> 
                                </tr>
                                    <?php } ?>
                                                                </tbody>

								</table>
                                	<h3>Aprobado Danilo Chamorro</h3>
									<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                                ...
                                <tr role="row" class="odd <?php switch($rowreview['adch']){ 
								case 0:
								echo 'danger';
								break;
								case 1:
                                ...
                                <td>Aprobado Danilo Chamorro</td>
                                <td><a href="<?php echo cleanURL($row['adch']); ?>" class="btn btn-xs default btn-editable" target="new"><i class="fa fa-link"></i> <?php echo cleanURL($row['adch']); ?></a> </td>
                                </tr>
...
function cleanURL($url){
	$cleanurl = str_replace('http://www.pagoscp.com/admin/','',$url);
	$cleanurl = str_replace('http://www.pagoscp.com/','',$cleanurl);
