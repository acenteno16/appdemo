                    ...
                    <div class="portlet-body">
                             ...
                             <?php /*<form action="withholding-mayor-tax-request-code.php" method="post" enctype="multipart/form-data" name="form2" id="form2"><div class="table-container">*/ ?>
								...
								if($nummain > 0){ ?> 
                               	...
                               	<?php //echo $query; ?>
                                <p><strong>ID de remision o grupo de Cancelación:</strong> <?php echo "#".$_GET['id']; ?><br>
...
?></td>
							...
							?>
                            <a href="<?php echo str_replace('http://getpay.casapellas.com.ni/admin/','',$filelink = $rowfiles['link']); ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a> 
						  ...
						  <h3 class="form-section"><a id="status"></a>Estado de grupo de cancelación</h3>
						...
						<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                               ...
                               <?php 
												 ...
												 $thisStatus = array();
												 $queryThisStatus = "select * from schedulestages";
												 ...
												 $querystatus = "select * from scheduletimes where schedule = '$_GET[id]' order by id asc";
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $rowstatus['id']; ?>
                                  </td><td><?php echo date('d-m-Y',strtotime($rowstatus['today'])); ?></td><td><?php echo date('h:i:s a', strtotime($rowstatus['now2'])); ?></td>
                                <td><?php 
								...
								$color = 'blue';	
								echo '<button type="button" class="btn '.$color.'" onClick="makeAlert('."'".$rowstatus['comment'].": ".$rowstatus['reason']."'".');">'.$thisStatus[$rowstatus['stage']].'</button>';
