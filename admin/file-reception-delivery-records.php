					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="file-reception-delivery.php"> Entrega de remisiones</a>
							<i class="fa fa-angle-right"></i>
...
<div class="row">
				<div class="col-md-12"><!-- Begin: life time stats -->
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<?php 
								...
								$query = "select * from packagestimes where stage = '3' order by id desc"; 
								...
								$query1 = "select * from packagestimes where stage = '3' order by id desc limit ".$inicio.",".$tampagina;  
                 ...
                 <li>
										<a href="file-reception-delivery-records.php?page=<?php echo $previous; ?>">
  ...
  for ($i=1;$i<=$totpagina;$i++){ 
        if ($pagina == $i){
		  ...
		  echo '<li><a href="file-reception-delivery-records.php?page='.$i.'">'.$i .'</a></li>'; 
		}
    } } ?>
             <?php if($next != ""){ ?>
                 ...
                 <li>
										<a href="file-reception-delivery-records.php?page=<?php echo $next; ?>">
										<i class="fa fa-angle-right"></i>
										</a>
									</li>
                  <?php } ?>
