					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="file-reception.php"> Recepción de remisiones</a>
<i class="fa fa-angle-right"></i>
						</li>
						<li>

							<a href="f#"> Historial</a>
...
<?php /*<div class="actions">
						...
						<div class="portlet-body">
							...
							<?php 
								...
								$query = "select * from packagestimes where stage = '2' order by id desc"; 
								$result = mysqli_query($con, $query);
								$numdev = mysqli_num_rows($result);
								$totpagina = ceil($numdev / $tampagina); 
								
								$query1 = "select * from packagestimes where stage = '2' order by id desc limit ".$inicio.",".$tampagina;  
                                ...
                                <?php while($rowtime=mysqli_fetch_array($result1)){
									...
									$row = mysqli_fetch_array(mysqli_query($con, "select * from packages where id = '$rowtime[package]' order by id desc limit 1"));
                 ...
                 <li>
										<a href="file-reception-records.php?page=<?php echo $previous; ?>">
  ...
  for ($i=1;$i<=$totpagina;$i++){ 
        if ($pagina == $i){
		  ...
		  echo '<li><a href="file-reception-records.php?page='.$i.'">'.$i .'</a></li>'; 
		}
    } } ?>
             <?php if($next != ""){ ?>
                 ...
                 <li>
										<a href="file-reception-records.php?page=<?php echo $next; ?>">
										<i class="fa fa-angle-right"></i>
										</a>
									</li>
                  <?php } ?>
