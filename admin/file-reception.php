		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Remisiones de Solicitudes <small>Recepción </small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="file-reception.php">Remisiones de Solicitudes</a>
                            <i class="fa fa-angle-right"></i>
                            </li>
							...
							<div class="tab-pane" id="tab_1">
								...
								<?php ?>
									...
									<div class="portlet-body form">
										...
										<form action="file-reception-code.php" class="horizontal-form" method="post" enctype="multipart/form-data">

											<div class="form-body">

												<h3 class="form-section">Ingresar remisión de Solicitudes de pago</h3>
				...
				<div class="col-md-12"><!-- Begin: life time stats -->
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">Remisiones de Solicitudes recibidas</div>
<div class="actions">

								<a href="file-reception-records.php" class="btn default blue-stripe">
						...
						<div class="portlet-body">
							...
							<?php $query = "select * from packagestimes where stage = '2' order by id desc limit 25";
