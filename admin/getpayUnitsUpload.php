...
Formulario para importar excel de actualización</div> 
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					 ...
					 <form name="importa" method="post" action="getpayUnitsUpload.php" enctype="multipart/form-data" > 
	...
	if(file_exists($destino)){
		...
		for($i=$filerow;$i<=$lastRow;$i++){ 
			...
			*/
			...
			$queryTc = "insert into unitsFinal2 (code, code2) values ('$code', '$code2')";
			$resultTc = mysqli_query($con, $queryTc); 
			$campo++;
...
*/	  
$queryPre = "select * from unitsFinal2";
$resultPre = mysqli_query($con, $queryPre); 
$numPre = mysqli_num_rows($resultPre);
?>	
		</div>	
