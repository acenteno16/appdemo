					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
                            ...
                            <li><a href="#">Retenciones IMI forzadas</a>
                                </li>
				...
				<div class="col-md-12">
                 ...
                 <div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="halls-retention-stuck-code.php" class="horizontal-form" method="post" enctype="multipart/form-data">
											...
											<div class="form-body">
												...
												<div class="row"><!--/span-->
													<div class="col-md-3">
														...
														<input type="text" class="form-control" id="theid[]" name="theid[]" placeholder="ID" value="<? echo $_GET['id']; ?>">
													</div>
													<div class="col-md-3 ">
												    ...
												    <label>Alcaldía Sugerida:</label>
													 <select name="hallid[]" id="hallid-<? echo $inc; $inc++; ?>" class="form-control">
                                  						<option value="0" selected>Definida en provisión</option>
                                  						<option value="999999999">Selección Automática</option>       
                                  						<?php 
