...
<p>Para importar un exel se deben de tomar en cuenta ciertas consideraciones que a contunuacion vamos a nombrar.</p><br>
<h4> <strong>El archivo a subir debe de ser un excel con extencion .XLSX </strong></h4>
<p>si el archivo que vamos a subir es .XLS debemos de abrirlo en excel y guardarlo con la extensión .XLSX</p>
<p>Para guardar este archivo en en XLSX, en el menu archivo pulsamos guardar como, luego nos fijamos que en el inferior de la ventana emergente este seleccionado la opcion XLSX.</p>
<br>
<h4><strong>El archivo debe de estar lo mas limpio posible.</strong></h4>
<p> El motor que guarda  los archivos .XLSX debe de analizar la información antes de guardarla en la base de datos. </p>
<p>Este proceso lo debe hacer antes de exceder el tiempo determinado por el servidor. Si el archivo no es procesado y guardado antes de que el tiempo de ejecucion del servidor sea exedido, los datos no se actualizan en la base de datos. Por lo que se recomienda mantener el documento libre de formulas y de caracteres especiales tales como pero no limitados a: <strong>:;=+-!@#$%^&amp;*()</strong> o bien  formatos como combinaciones de celdas, negritas, color de fondode celdas, etc.</p>
<p>
  <?php /*
<video width="100%"  controls>
  <source src="videos/payment-approve.mp4" type="video/mp4"> 
