...
if(($id == "") or ($id == "0")){ 
    exit("<script>alert('No se reconoce el ID: $id del pasante.'); window.location = 'interns.php';</script>");
}
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Pasantes <small><? if($id == "new") echo "Agregar Pasante"; else echo "Editor de Pasante"; ?></small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="interns.php">Pasantes</a>
                             <i class="fa fa-angle-right"></i>
                             </li>

						<li>

							<a href="#"><? if($id == "new") echo "Agregar Pasante"; else echo "Editor de Pasante"; ?></a>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form name="porder" id="porder" action="interns-edit-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" <? //onsubmit="return validateForm();" ?>>
											...
											<div class="form-body">
												...
												<h3  class="form-section">Información del Pasante</h3> 
...
<? 
    ...
    ?>
    <option value="1" <? if($row['type'] == 1) echo "selected"; ?>><? echo $rowcompany['name']; ?></option> 
<? } ?>
</select>
...
<div class="form-group">
<label>Unidad:</label>
<input name="unit" type="text" class="form-control" id="unit" value="<? echo $row['unit']; ?>"  > 
</div>
</div>
    <div class="row"></div>
<div class="col-md-3 ">
...
<input name="first" type="text" class="form-control" id="first" value="<? echo $row['first']; ?>"  > 
</div>
</div>
    <div class="col-md-3 ">
<div class="form-group">
<label>Segundo nombre:</label>
<input name="first2" type="text" class="form-control" id="first2" value="<? echo $row['first2']; ?>"  > 
</div>
</div>
<div class="col-md-3 ">
<div class="form-group">
<label>Primer apellido:</label>
<input name="last" type="text" class="form-control" id="last" value="<? echo $row['last']; ?>"  > 
</div>
</div>
    <div class="col-md-3 ">
<div class="form-group">
<label>Segundo apellido:</label>
<input name="last2" type="text" class="form-control" id="last2" value="<? echo $row['last2']; ?>"  > 
</div>
</div>
<div class="col-md-12 ">
<div class="form-group">
<label>Dirección:</label>
<input name="address" type="text" class="form-control" id="address" value="<? echo $row['address']; ?>"  > 
</div>
</div>
...
<div class="form-group">
<label>Cédula:</label>
<input name="nid" type="text" class="form-control" id="nid" value="<? echo $row['nid']; ?>"  > 
</div>
</div>
<div class="col-md-3 ">
<div class="form-group">
<label>Email:</label>
<input name="email" type="text" class="form-control" id="email" value="<? echo $row['email']; ?>"  > 
</div>
</div>
<div class="col-md-3 ">
<div class="form-group">
<label>Teléfono:</label>
<input name="phone" type="text" class="form-control" id="phone" value="<? echo $row['phone']; ?>"  > 
</div>
</div>
    <div class="row"></div>
