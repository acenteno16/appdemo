...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Mensajeros <small>+Agregar Mensajero</small>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form"> 
										...
										<form action="messengers-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form">  
	...
	<input name="last" type="text" class="form-control" id="last">
											...
											<div class="form-actions right">
												...
												<button type="button" class="btn default" onClick="goBack();">Cancelar</button>
												<script>
												function goBack(){
