		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Noticias <?php //<small>Ordenes de pago</small> ?>
...
<video width="100%"  controls>
  <source src="videos/payment-order.mp4" type="video/mp4"> 
