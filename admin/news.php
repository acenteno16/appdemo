					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="news-add.php" class="btn default blue-stripe">
...
$query1 = "select * from news order by id desc limit ".$inicio.",".$tampagina;$result1 = mysqli_query($con, $query1); 
...
if($numdev > 0){  ?>
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?></td><td><?php echo $row['name']; ?></td><td><?php 
								
			echo date('d-m-Y', strtotime($row['today']))." @".$row['totime'];					
...
?> </td><td>
                            ...
                            <a href="news-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver/Editar</a>     <a href="javascript:deleteNews(<?php echo $row['id']; ?>)" class="btn btn-xs red btn-editable"><i class="fa fa-trash-o"></i> Eliminar</a>          
...
function deleteNews(id){
	if(confirm('Esta seguro de eliminar esta noticia?') == true){
		window.location = 'news-delete-code.php?id='+id; 
	}
}
