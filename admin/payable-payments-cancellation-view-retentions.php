							...
							$row = mysqli_fetch_array($result);
                                ...
                                <?php /*<td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                                  ...
                                  <td><a href="payment-order-view.php?id=<?php echo $row['id']; ?>"><span class="sorting_1">
                                   <?php if($row['status'] < 14){ ?> <input name="theid[]" type="hidden" id="theid[]" value="<?php echo $row['id']; ?>"><?php } ?>
...
?></td>
                            <?php if($row['status'] < 14){ ?>
                                <td>
                            <select name="link[]" class="form-control  select2me" id="link[]" data-placeholder="Seleccionar..." onChange="javascript:reloadNumbers(),validateBill();"> 
...
?>
                         ...
                         <?php //if($rowprovider['international'] != 1){ ?>   <input name="reference[]" type="text" class="form-control" id="reference[]" value="<?php echo $rowgroup['code']; ?>" placeholder="Número de referencia (Banco)"> 
                            ...
                            <?php } ?>
								...
								?>
                                       ...
                                       <div class="form-actions right" style="text-align:right;">
											    	...
											    	<input name="group" type="hidden" id="group" value="<?php echo $_GET['id'];  ?>"><button type="submit" class="btn blue"><i class="fa fa-check"></i> Cancelar pago</button><br>
