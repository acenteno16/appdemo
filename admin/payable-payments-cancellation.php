...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="#">Programación de pagos</a>
                    ...
                    <div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								...
								<i class="fa fa-sitemap"></i>Lista de pagos programados</div>
						...
						<div class="portlet-body">
							...
							<?php $query = "select * from payments".$sql;
	...
	//echo ' ('.$dias.")";
?></td><td> <?php echo date('d-m-Y',strtotime($row['schedule'])); ?> 	
