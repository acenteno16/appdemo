...
$sql1 = "";
if($gid != ""){
    $sql1 = " and schedule.id = '$gid'";
}
$id = $_GET['id'];
$sql2 = "";
if($id != ""){
    $sql2 = " and schedulecontent.payment = '$id'";
    $join1 = 1;
}
...
$join = "";
if($join1 == 1){
    $join.=" inner join schedulecontent on schedule.id = schedulecontent.schedule";
}


$query = "select schedule.* from schedule$join where schedule.status >= '6'$sql order by schedule.id desc"; 
$result = mysqli_query($con, $query);
$num = mysqli_num_rows($result); 
$totpagina = ceil($num/$tampagina);      

$query1 = "select schedule.* from schedule$join where schedule.status >= '6'$sql order by schedule.id desc limit ".$inicio.",".$tampagina."";
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="payable-payments.php">Cancelación de pagos
										  ...
										  <!--/row--><!--/row--></div>
											...
											<div class="form-actions right">
                                                ...
                                                <script> function cancelAction(){
                                                        window.location = "payable-payments-group.php";
                                                    }
                                                </script>
...
<div class="table-scrollable">
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
                                ...
                                <tr role="row" class="odd <?php if($row['status'] == 7) echo 'success'; ?>"> 
							...
							</td><td><a href="payable-payments-group-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
                 ...
                 <li>
										<a href="<?php echo str_replace('/var/www/html','',$_SERVER['SCRIPT_FILENAME']); ?>?page=<?php echo $previous; ?>">
  ...
  for ($i=1;$i<=$totpagina;$i++){ 
        if ($pagina == $i){
		  ...
		  echo '<li><a href="'.str_replace("/var/www/html","",$_SERVER["SCRIPT_FILENAME"]).'?page='.$i.'">'.$i .'</a></li>';  
		}
    } } ?> 
             <?php if($next != ""){ ?>
                 ...
                 <li>
										<a href="<?php echo str_replace('/var/www/html','',$_SERVER['SCRIPT_FILENAME']); ?>?page=<?php echo $next; ?>">
										<i class="fa fa-angle-right"></i>
										</a>
									</li>
                  <?php } ?>
 ...
 <?php } else { 
						...
						<p>
							...
							NOTA: No se encontró ningún grupo cancelado.
