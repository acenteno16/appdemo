...
$query = "select * from payments where id = '$_GET[id]'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_array($result);

if($row['retroute'] == 0){
	echo "<script>alert('No se reconoce este ID.'); history.go(-1);</script>";
	exit();
}
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="retentions-home.php">Retenciones
</a>
				<i class="fa fa-angle-right"></i>			
			...
			<div class="row">
                  ...
                  <div class="col-md-12"><!-- Begin: life time stats -->
                    ...
                    <div class="portlet-body">
                   	  	...
                   	  	<form id="payable" name="payable" enctype="multipart/form-data" method="post" action="payable-payments-retentions-view-code.php">
				 ...
				 checkboxes[i].checked = false;
							...
							//if($nioammount > 1){
								...
								elseif($row['btype'] == 2){
									...
									$rowprovider = mysqli_fetch_array(mysqli_query($con, "select * from interns where code = '$row[intern]'"));
								}
...
?></td>
                            ...
                            <input name="number[]" type="text" class="form-control" id="number[]" value="" placeholder="Número de transacción (CKPK)">
