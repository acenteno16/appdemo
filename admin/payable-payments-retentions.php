<?php include("session-retentionmanager.php"); ?>
<!DOCTYPE html>
...
$query = "select * from payments where status = '9' and retroute = '1' order by id asc"; 
$result = mysqli_query($con, $query);  
$num = mysqli_num_rows($result); 
$row = mysqli_fetch_array($result);
echo $num; ?> Pagos pendientes de cancelación
...
?></td>
                            <?php if($row['status'] < 14){ ?>
                                <td><a href="payable-payments-retentions-view.php?id=<? echo $row[0]; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a></td>
                            <?php } ?>
                            </tr>
 ...
 <?php } 
						...
						<p>
							...
							NOTA: No se encontraron pagos pendientes de cancelación.
