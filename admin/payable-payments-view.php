		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Pagos <small>Cancelación de pagos.</small>
...
<div class="portlet"><div class="portlet-title">
							...
							<div class="actions">
								...
								<?php if($_GET['visor'] == 1){ ?>
                                <a href="payable-payments-view.php?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
                                ...
                                <?php }else{ ?>
                                <a href="payable-payments-view.php?id=<?php echo $_GET['id']; ?>&visor=1" class="btn default blue-stripe">
...
<div class="portlet-body form">
										...
										<form action="payable-payments-view-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
...
<?php } ?>
										 ...
										 ?> <h3 class="form-section">Cancelación del pago</h3>  
                                         									<div class="row">
 <?php /*<div class="col-md-4">

													<div class="form-group">
                                                     <label>Batch de cancelación: </label>
                                        <input name="cancellationbatch" type="text" class="form-control" id="cancellationbatch" placeholder="">                                   
              </div> 

												  </div> */ ?>
  <div class="col-md-12 "><p>Favor adjuntar enlace a comprobante de cancelación de pago e indicar el número de transacción.</p><br>
</div>                                                <div id="emails">
                                                    
                                                     <div class="col-md-5 ">
													  <div class="form-group">
													   <label>Link</label>
                                                       <input name="clink" type="text" class="form-control" id="clink" placeholder="Ej: http://www.ejemplo.com" value=""><br><div class="row"></div></div></div> 
                                                        <div class="col-md-5 ">
													  <div class="form-group">
													    <label>Número de transacción</label>
                                                         <input name="cnumber" type="text" class="form-control" id="cnumber" placeholder="Ej: 000000000" value="">
...
<label>Comentarios:</label>
  ...
  <div class="col-md-12 "><div class="form-actions right">
			...
			window.location="payable-payments-view-deny.php?id=<?php echo $_GET['id']; ?>&reason="+reason+"&reason2="+reason2;  
		}else{
			...
			<?php /*function denyPayment(){
				if (confirm("Esta usted seguro de querer rechazar esta solicitud?\n- Si usted no desea rechazar presione cancelar.")==true){
			window.location="payable-payments-view-deny.php?id=<?php echo $_GET['id']; ?>";
			//alert ("ok");
		}
			}*/ ?>
...
function validateForm(){
	...
	if((clink == "")){
		alert('Debe de ingresar el link del documento.');
		return false;
		}
	var cnumber = document.getElementById("cnumber").value;
	if((cnumber == "")){
		alert('Debe de ingresar el no. de transaccion.');
		return false;
		}
}
</script>
