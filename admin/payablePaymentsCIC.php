...
if(isset($join2)){
	$join.=$join2;$result1 = mysqli_query($con, $query1);
}
...
$query = "select schedule.* from schedule inner join schedulecontent on schedule.id = schedulecontent.schedule join payments on payments.id = schedulecontent.payment".$join." where payments.pce1 = '1' and payments.ppe1 != '1' and (payments.ppe1 = '0' or payments.ppe1 = '2')".$sql." group by schedule.id order by schedule.id desc";  
$result = mysqli_query($con, $query);
$num = mysqli_num_rows($result);  
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);      

$query1 = "select schedule.* from schedule inner join schedulecontent on schedule.id = schedulecontent.schedule join payments on payments.id = schedulecontent.payment".$join." where payments.pce1 = '1' and payments.ppe1 != '1' and (payments.ppe1 = '0' or payments.ppe1 = '2')".$sql." group by schedule.id order by id desc limit ".$inicio.",".$tampagina;
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Cancelación de pagos CIC<?php /*<small>Aprobación de programación</small> */ ?>
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="#">Cancelación de pagos CIC
 </a>
					...
					<div class="portlet">
						  ...
						  <div class="portlet">
									...
									<div class="portlet-body form">
										  ...
										  <? #if($_SESSION['email'] == 'jairovargasg@gmail.com1'){ ?>
...
<br><br>
						<div class="col-md-4">							
						    ...
						    <input type="hidden" id="form" name="form" value="1"><button type="submit" class="btn blue"><i class="fa fa-filter"></i> Filtrar</button><input type="button" class="btn blue" style="margin-left:5px;" onClick="window.location='payablePaymentsCIC.php';" value="Limpiar Filtro"> 
...
echo $num; ?> Grupos pendientes de cancelación CIC
							...
							<div class="actions">
								...
								<a href="payablePaymentsGroups.php" class="btn default blue-stripe" target="_blank">
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
							...
							</td><td><a href="payablePaymentsCICView.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
