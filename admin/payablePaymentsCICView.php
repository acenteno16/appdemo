				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="payablePaymentsCIC.php">Cancelación de pagos
</a>
                  ...
                  <div class="col-md-12"><!-- Begin: life time stats -->
                    ...
                    <div class="portlet-body">
                             ...
                             <?php /*<form action="withholding-mayor-tax-request-code.php" method="post" enctype="multipart/form-data" name="form2" id="form2"><div class="table-container">*/ ?>
                               ...
                               <? if($rowgroup['bank'] != 0){ ?> <strong>Banco:</strong> <? 
							  $rowBank = mysqli_fetch_array(mysqli_query($con, "select * from banks where id = '$rowgroup[bank]' order by id desc"));
									echo $rowBank['name'].'<br>';
...
<strong>Fecha:</strong> <?php echo date('d-m-Y',strtotime($rowgroup['today'])); ?><br>
                      ...
                      <strong>No. de Solicitudes:</strong> <?php echo $nummain; ?><br>
                                	...
                                	<form id="payable" name="payable" enctype="multipart/form-data" method="post" action="payablePaymentsCICViewCode.php">
			 	...
			 	checkboxes[i].checked = false; 
                                ...
                                <tr role="row" class="odd <?php if($row['status'] == 14) echo "success"; ?>"> 
									...
									<td class="sorting_1"> 
										...
										<input name="theid[]" type="checkbox" id="id[]" value="<?php echo $row['id']; ?>" class="approve0" <? if($rowLetters['parent'] > 0) echo 'disabled'; ?>>
...
?></td>
                            ...
                            <? 
                                    ...
                                    ?>        
                            <input name="number[]" type="text" class="form-control" id="number[]" value="" placeholder="<? if($thisActive == 1){ echo 'Número de transacción (CKPK)'; }else{ echo "En espera de CC"; } ?>" <? if($thisActive == 0) echo "disabled"; ?>>
...
<?php //} ?>
                            ...
                            <input name="international[]" type="hidden" id="international[]" value="<?php echo $rowprovider['international']; ?>">
								...
								?>
											    	...
											    	<input name="group" type="hidden" id="group" value="<?php echo $_GET['id'];  ?>">
 <div class="row">                                                   
<div class="col-md-4">  
<label>Archivo:</label>                                                  				<select name="link" class="form-control  select2me" id="link" data-placeholder="Seleccionar..." onChange="javascript:reloadNumbers(),validateBill();"> 
											  ...
											  <option value="<? echo $row['clinkid'].':::'.$row['clink']; ?>"><? echo $row['clink']; ?></option>
<?php 
