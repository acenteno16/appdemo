										  ...
										  <!--/row--><!--/row--></div>
											...
											<div class="form-actions right">
                                                ...
                                                <script> function cancelAction(){
                                                        window.location = "payablePaymentsGroups.php";
                                                    }
                                                </script>
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
							...
							</td><td><a href="payablePaymentsGroupsView.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
