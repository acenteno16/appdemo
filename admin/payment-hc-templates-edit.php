...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Plantillas <small>Solicitud de Pago</small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="payments.php">Solicitudes</a>
                             <i class="fa fa-angle-right"></i>
                             </li>
							<li>

							<a href="payment-hc-templates.php">Plantillas</a>
                             <i class="fa fa-angle-right"></i>
                             </li>

						<li>

							<a href="#">Agregar/Editar</a>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form name="porder" id="porder" action="payment-hc-templates-edit-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
	...
	<label class="control-label">Nombre de la plantilla:</label>
										
											  <input name="name" type="text" class="form-control" id="name" value="<?php echo $rowTemplate['name']; ?>">  
...
<div class="row">												
<? #Colaboradores ?>	
<div class="col-md-12" id="dAlimony">
	...
	<label class="control-label">Colaborador:</label>
											...
											<select name="collaborator2" class="form-control  select2me" id="collaborator2" data-placeholder="Seleccionar..." > 
	...
	<label class="control-label">Proveedor:</label>
											...
											<select name="provider2" class="form-control  select2me" id="provider2" data-placeholder="Seleccionar..." onChange="" >  
...
?>
                                                ...
                                                <?php } ?>
														  ...
														  <button type="button" class="btn blue icn-only" onclick="addThis();">+</button>
...
$inc = 1;
$queryContent = "select * from hcTemplatesContent where template = '$id'";
...
<div class="row">
	...
	switch(4){
		case 1:
		$queryBen = "select * from providers where id = '$rowContent[ben]'";
		...
		$theId = $rowContent[ben];

		break;
		case 2:
			$queryBen = "select * from workers where id = '$rowContent[ben]'";
			$resultBen = mysqli_query($con, $queryBen);
			$rowBen=mysqli_fetch_array($resultBen);
		...
		break;
		case 3:
			$queryBen = "select * from interns where code = '$rowContent[ben]'";
			$resultBen = mysqli_query($con, $queryBen);
			$rowBen = mysqli_fetch_array($resultBen);
			$ben = "$rowBen[code] | $rowBen[first] $rowBen[first2] $rowBen[last] $rowBen[last2]";
			$theId = $rowContent[ben];
		break; 
		case 4:
...
?><div id="roc<? echo $inc; ?>">
<div class="col-md-8"><input type="hidden" name="bid[]" value="<? echo $theId; ?>"> <input type="text" class="form-control" value="<? echo $ben; ?>"></div><div class="col-md-1"><div class="form-group"><label>&nbsp;</label><button type="button" class="btn red" onClick="javascript:deleteRow('<? echo $inc; ?>');">-</button></div></div></div>
...
function sType(val){
	...
	if(val == 4){
		hideAll();
		document.getElementById('dAlimony').style.display = 'block';
	}
...
function hideAll(){
	...
	document.getElementById('dAlimony').style.display = 'none';
}	
var noItem = <? echo $inc; ?>;	
function addThis(){
	...
	var collaborator2 = document.getElementById('collaborator2').value;
	$.post("payment-hc-templates-reload.php", { collaborator2: collaborator2, provider2: provider2 }, function(data){
		var newItem = '<div id="item'+noItem+'">'+data+'<div class="col-md-1 "><div class="form-group"><button type="button" class="btn red" onclick="javascript:deleteRowItem('+noItem+');">-</button></div></div></div>'; 
		noItem++; 
		$("#tContent").append(newItem);
		
	}); 
	
	$("#provider2").select2("val", "");
	$("#collaborator2").select2("val", "");
...
function cancelAction(){
	if (confirm("Esta Seguro de cancelar este ingreso?\n")==true){
			window.location = 'payment-hc-templates.php';
		}
}
