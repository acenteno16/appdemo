                	...
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions"> 
                             ...
                             <a href="payment-hc-templates-add.php" class="btn default blue-stripe">
...
function deleteThis(id){
		if (confirm("Usted desea eliminar este Usuario\n- Si usted no desea eliminar el Usuario presione cancelar.")==true){
			window.location="payment-hc-templates-delete.php?id="+id;	
		}
	}
</script>
<!-- END JAVASCRIPTS --
