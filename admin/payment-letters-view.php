...
echo $row_account1[1]." - ".$row_account1[2]." (".$row_account1[3].')';
?>" readonly>
</div>
...
echo $row_account2[1]." - ".$row_account2[2]." (".$row_account2[3].')';
?>" readonly>
<?                                                           
/*
...
<div class="col-md-4 ">
													  <div class="form-group">
														<label>Monto:</label>
                                                        <input name="amount" type="text" class="form-control" id="amount" value="<? if($rowpconfirm['amount'] > 0){ echo $rowpconfirm['amount']; } ?>" readonly>
...
<? include('stage-provision-letters.php'); ?>
