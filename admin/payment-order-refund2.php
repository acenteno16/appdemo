...
<div class="radio-list" style="margin-left:30px;">
										  ...
										  <label class="radio-inline">
										  <div class="radio1" id="uniform-optionsRadios4"><span class="checked2">
                                          <input type="radio" name="devtype" id="devtype" onClick="javascript:reloadRequirements(this.value);" value="5" <? if($rowrefund['devtype'] == 5) echo "checked"; ?> <?php //checked ?>></span></div> Devolución de Producto</label>
...
<input name="rsvp" type="text" class="form-control date-picker" id="rsvp" value="<? if($rowrefund['rsvp'] != ""){ echo date('j-n-Y', strtotime($rowrefund['rsvp'])); } ?>" readonly>                                                     </div>
</div>
...
<div class="col-md-4 ">
<div class="form-group">
<label>No. Informe de Negociación:</label>
...
if($numroutes == 1){
	...
	//echo '<br>'.strlen($rowroutes['unit']);
	//echo '<br>'.$rowroutes['unit'];
