													...
													<div class="row"></div>
                                                     ...
                                                     <div class="col-md-10 ">
													  <div class="form-group">
                                                        ...
                                                        $querysolvency = "select * from paymentsSolvency where payment = '$_GET[id]' order by id desc limit 1";
...
<?php 
                                               # echo $rowpconfirm['routeid'];
echo $queryroutes = "select units.id, units.newCode, units.companyName, units.lineName, units.locationName, routes.headship from routes inner join units on routes.unitid = units.id where routes.worker = '$rowpconfirm[userid]' and routes.type = '1' and units.active = '1' order by routes.unit";
...
?>
<option value="<?php echo $thecode; ?>,<?php echo $rowroutes['headship']; ?>" class="<?php echo $rowpconfirm['route']; ?>" <?php if($thecode == $rowpconfirm['routeid']) echo 'selected'; ?>><?php echo $rowroutes['newCode']." | ".$thename; if($rowroutes['headship'] > 0){ echo ' > '.$rowheadship['name']; } echo '#'.$thecode; ?></option>
<?php } ?>
															</select> 
    </div>
	<?php
...
?>
<option value="<?php echo $thecode; ?>,<?php echo $rowroutes['headship']; ?>" class="<?php echo $rowpconfirm['route']; ?>" <?php if($thecode == $rowpconfirm['routeid']) echo 'selected'; ?>><?php echo $thename; if($rowroutes['headship'] > 0){ echo ' > '.$rowheadship['name']; }  echo '#'.$thecode; ?></option>
<?php } ?>
															</select>
                       ...
                       <!--/row-->
                                            ...
                                            <div class="col-md-12">
													  ...
													  <div class="form-group">
                                                          ...
                                                          <label class="control-label">Afectar: <br><br>
                                                              
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateBeneficiary" name="updateBeneficiary"/> Beneficiario<br>
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateType" name="updateType"/> Tipo - Concepto - Categoria<br>
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateDocumments" name="updateDocumments"/> Documentos (Calculos)<br>
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateFiles" name="updateFiles"/> Archivos<br>
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateDistribution" name="updateDistribution"/> Distribucion<br>
                                                              <input type="checkbox" value="1" class="group-checkable" id="updateRoute" name="updateRoute"/> Ruta<br>
