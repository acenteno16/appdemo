							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form name="porder" id="porder" action="payment-order-repair2-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
...
<?php 
$queryfbox = "select * from filebox where user = '$rowpconfirm[userid]' order by id desc limit $global_limit";
...
<input type="hidden" name="billId[]" id="billId[]" value="<? echo $rowbill['id']; ?>">
...
<input type="hidden" id="billid[]" name="billid[]" value="<?php echo $rowbill['id']; ?>">    
<?php } ?>
<div id="row"><div class="col-md-12 "> &nbsp;</div></div>
</div> 
<?php 
...
<?php 
/*
$queryroutes = "select units.id, units.newCode, units.companyName, units.lineName, units.locationName, routes.headship from routes inner join units on routes.unitid = units.id where routes.worker = '$rowpconfirm[userid]' and routes.type = '1' and units.active = '1' order by routes.unit";
...
<?php } */ ?>  
                                                      ...
                                                      <div id="row">
                                                          ...
                                                          <div class="col-md-12 ">
                                                              <div class="form-group">
                                                                  ...
                                                                  <textarea name="notesrep" rows="2" class="form-control" id="notesrep"></textarea>
                                                              </div>
                                                          </div>
											...
											<div class="form-actions right" style=" margin-top:60px;;">
