...
?>
<option value="<?php echo 'http://getpay.casapellas.com.ni/admin/visor.php?key='.$rowfbox['url'];  ?>"<?php if(cleanLink($rowfilemain['link']) == $rowfbox['url']){ echo 'selected'; $fileFound = 1; } ?>><?php echo $rowfbox['id']." | ".$rowfbox['title']; ?></option>
<?php } 
if($fileFound == 0){ 
...
<option value="1" <?php if($rowpconfirm['immediate'] == 1) echo 'selected'; ?>>Si</option> 
	...
	<label class="control-label">Código | Nombre:</label>
											...
											<select name="provider" class="form-control  select2me" id="provider" data-placeholder="Seleccionar..." onChange="reloadNumbers(),loadInsurerInfo(this.value),loadCreditcardInfo(this.value);" >  
...
<div class="row"></div>
   ...
   <?php if($typeinc > 0){ ?> <div id="row"><div class="col-md-12 "> &nbsp;</div></div><div class="col-md-12"><button type="button" class="btn red icn-only" onclick="deleteBill(<?php echo $typeinc; ?>),reloadNumbers();"><i class="fa fa-trash-o"></i> Eliminar Documento</button></div> 
    <?php } ?>
