		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Pagos <small>Control de Calidad</small> 
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								<?php $query = "select * from payments where stage = '14' order by id desc";
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?></td><td><?php if($row['btype'] == 1){
								$rowprovider = mysqli_fetch_array(mysqli_query($con, "select * from providers where id = '$row[provider]'"));
								}else{
										$rowprovider = mysqli_fetch_array(mysqli_query($con, "select * from workers where id = '$row[collaborator]'"));
								}
								echo $rowprovider['code']; ?></td><td><?php if($row['btype'] == 1){
								...
								?></td><td><?php echo $row['payment']; ?></td><td><?php echo $row['expiration']; ?></td><td><?php echo $rowstage['content']; ?> 
									
							
								
							</td><td><a href="payment-order-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a> <a href="javascript:deletePayment(<?php echo $row['id']; ?>);"><span class="label label-danger">

								  <i class="fa fa-trash-o"></i> Eliminar </span></a> </td></tr>
                                <?php } } else { ?>
