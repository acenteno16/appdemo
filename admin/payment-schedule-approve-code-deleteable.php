	...
	$result7 = mysqli_query($con, $query7); 	
		...
		if($row3['status'] == 1){
			...
			while($rowgroup=mysqli_fetch_array($resultgroup)){ 
				...
				$query1 = "update payments set status = '13', bank='$bank[$c]' where id = '$rowgroup[payment]'";
				...
				//Notificamos a los proveedores que ya se proceso el pago.
				 
				notifyCancellation($rowgroup['payment'],$forwarding); 
...
/*
			...
			sendEmailRetention($rowpayment['id'],$forwarding); 
