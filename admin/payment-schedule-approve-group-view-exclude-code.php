...
$queryschedule = "UPDATE schedule SET ammount = ? WHERE id = ?";
$stmt = $con->prepare($queryschedule);
$stmt->bind_param("di", $gpayment, $schedule);
$stmt->execute(); 

header('location: payment-schedule-approve-group-view.php?id='.$schedule);   
