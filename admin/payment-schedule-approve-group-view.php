		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Ingreso a Banco<?php //<small>Aprobación</small> ?> 
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="payment-schedule-approve-group.php?currency=<?php echo $_GET['currency']; ?>">Grupos de programación</a>
				 ...
				 checkboxes[i].checked = false;
							...
							$row = mysqli_fetch_array($result);
                                ...
                                <?php /*<td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                                  ...
                                  <td>                                  <? if($row['d_approve'] == 1) echo '<img src="../images/flag-blue.png" width="13" alt=""/> '; ?> <?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; 
								 echo $ben_name; ?></td>
                                  <td> <?php 
							   switch($row['currency']){
								  case 1:
...
?></td>
                            ...
                            <a href="payment-schedule-approve-group-view-exclude.php?id=<?php echo $row['id']; ?>" class="btn btn-xs red btn-editable"><i class="fa fa-times"></i> Excluir</a> 
                          ...
                          <form action="payment-schedule-approve-group-reject.php" class="horizontal-form" method="get" enctype="multipart/form-data" onsubmit="return validateForm();" id="myform">
                          <div class="row">   <div class="col-md-12" id="cdiv">
													  <div class="form-group">
											

		
<label>Comentarios:</label>
                                                        <textarea name="reason" rows="2" class="form-control" id="reason" placeholder="Comentarios de rechazo de Programación."></textarea>
...
<div class="row"><button type="submit" class="btn red"><i class="fa fa-times"></i> Reprobar</button></div> 
...
function validateForm(){
	...
	if(reason.value == ""){
		alert('Usted debe de proporcionar una razon de rechazo.');
		reason.focus();
		return false;
	}
	if(confirm('Esta usted seguro de rechazar este grupo de pago') == true){
		//Do nothing 
	}else{
		return false;
	}
