...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Programación de pagos <small>Aprobación de programación</small> 
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
							...
							<a href="payment-schedule-approve.php">Aprobación de programación</a>
    ...
    <div class="col-md-12"><!-- Begin: life time stats -->
                    ...
                    <div class="portlet">
						...
						Grupos aprobación de programación
...
$query = "select * from schedule where status >= '3'".$sql." order by id desc"; 
$result = mysqli_query($con, $query);
$num = mysqli_num_rows($result); 
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);      

$query1 = "select * from schedule where status >= '3'".$sql." order by id desc limit ".$inicio.",".$tampagina;
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
                                ...
                                <?php /*<td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                                  ...
                                  <td><?php echo $row['today']; 
								  ?><br>
                                    
</td><td><?php echo $row['now2']; ?></td>
							...
							?>
                            </td><td><a href="payment-schedule-approve-group-view.php?id=<?php echo $row['id']; ?>&currency=<?php echo $_GET['currency']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
