			...
			<div class="invoice">
				...
				<div class="row">
                    ...
                    <div class="col-md-12">
						...
						<h3>Impresión de aprobación de programación:</h3>
				...
				<div class="row">
                  ...
                  <?php $currency = $_GET['currency'];
					...
					if($currency == 0){
						$sql = " and (currency = '3' or currency = '4')";
					}
					$query = "select * from payments where status = '12'".$sql." order by schedule asc";
...
Pagar</th>
 ...
 para</th>
                                ...
                                <tr role="row" class="odd" style="font-size:11px;"><td class="sorting_1"><?php echo $row['id']; ?><input type="hidden" name="theid[]" id="theid[]" value="<?php echo $row['id']; ?>"></td><td><?php echo $rowprovider['code']; ?></td><td><?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; 
