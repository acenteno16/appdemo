...
$query = "select schedule.* from schedule".$join." where schedule.vo = '0' and schedule.ammount > '0'".$sql." group by schedule.id order by schedule.id desc";  
$result = mysqli_query($con, $query);
$num = mysqli_num_rows($result);  
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);      

$query1 = "select schedule.* from schedule".$join." where schedule.vo = '0' and schedule.ammount > '0'".$sql." group by schedule.id order by id desc limit ".$inicio.",".$tampagina;
...
<div class="portlet">
						...
						<? //echo $numdev; ?> Grupos de programación (Pendientes de VoBo)
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
                                ...
                                <td class="sorting_1" id="maintheid<?php //echo $table; ?>"> 
								  ...
								  $querycompany = "select companies.name from companies inner join units on companies.code = units.companyCode inner join payments on payments.routeid = units.id inner join schedulecontent on payments.id = schedulecontent.payment where schedulecontent.schedule = '$row[0]'";
...
<td><?php echo date('h:i:s a', strtotime($row['now2'])); ?></td>
 ...
 <?php } else { 
						...
						<p>
							...
							NOTA: No hay grupos de programación pendientes de VoBo.
