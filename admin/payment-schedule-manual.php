		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Programación manual de pagos <?php //<small>Ordenes de pago</small> ?> 
					</h3>
...
<form id="schedule" name="schedule" action="payment-schedule-manual-code.php" method="post" enctype="multipart/form-data">
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?><input id="id[]" name="id[]" value="<?php echo $row['id']; ?>" type="hidden"></td><td><?php echo $rowprovider['code']; ?></td><td><?php if($row['btype'] == 1){ echo $rowprovider['name'];
								}else{
									echo $rowprovider['first']." ".$rowprovider['last']; } ?></td><td><?php echo $row['payment']; ?></td><td><?php $date1 = date("Y-m-d");
...
?></td><td><?php echo $rowstage['content']; ?> 
							...
							</td><td><div class="form-group"><a href="payment-schedule-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a>
							
					
<input name="schedule[]" type="text" class="form-control form-control-inline date-picker" id="schedule[]" value=""></div></td></tr>
                                <?php } ?>
                                
                                 </tbody>

								
</table>                               <div class="form-actions right">
