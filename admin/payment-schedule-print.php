		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Programación de pagos <small></small></h3>
				...
				<div class="col-md-12">
                   ...
                   <div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="payment-schedule-print-view.php" class="horizontal-form" method="post" enctype="multipart/form-data" target="_blank">

											<div class="form-body">

												<h3 class="form-section">Filtrar programaciones de pago</h3>
