...
<label>Comentarios:</label>
 ...
 <div class="col-md-12 "><div class="form-actions right">
                                        ...
                                        <button type="button" class="btn blue" onClick="closeWindow();"><i class="fa fa-check"></i> Cerrar esta ventana</button> 
			...
			window.location="payment-schedule-view-deny.php?id=<?php echo $_GET['id']; ?>&reason="+reason+"&reason2="+reason2;  
		}else{
			...
			<?php /*function denyPayment(){
				if (confirm("Esta usted seguro de querer rechazar esta solicitud?\n- Si usted no desea rechazar presione cancelar.")==true){
			window.location="payment-schedule-view-deny.php?id=<?php echo $_GET['id']; ?>";
			//alert ("ok");
		}
			}
			*/ ?>
