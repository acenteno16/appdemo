...
<div class="note note-regular">
								<div class="row"><h4 style="margin-left:15px;">Filtro de pagos:</h4><br>
                ...
                <div class="portlet">
						...
						<div class="portlet-body">
							...
							<div class="table-container">
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?><input type="hidden" name="theid[]" id="theid[]" value="<?php echo $row['id']; ?>"></td><td><?php echo $rowprovider['code']; ?></td><td><?php echo $rowprovider['name']; ?></td><td><?php echo $row['payment']; ?></td><td><?php echo $rowprovider['term']; ?> días</td><td><?php echo $rowstage['content']; ?> 
...
if(schedule == ''){
	...
	return false;
				...
				?>
                  <form id="theform<?php echo $table; ?>" name="theform<?php echo $table; ?>" action="payment-schedule-code.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm<?php echo $table; ?>();">	
                <div class="portlet">
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								<tr role="row" class="heading">
									...
									<th width="3%" id="mainselectall<?php echo $table; ?>"><input name="selectall" type="checkbox" id="selectall<?php echo $table; ?>" value="3" onChange="javascript:selectAll<?php echo $table; ?>();"></th>
                                 <script>

function selectAll<?php echo $table; ?>(){
$('#mainselectall<?php echo $table; ?> span')
  .change(function() {
	
	if($('#mainselectall<?php echo $table; ?> span' ).hasClass('checked')){
		$('#maintheid<?php echo $table; ?> span').removeClass('checked');
	}else{
		
		$('#maintheid<?php echo $table; ?> span').addClass('checked');
	}
...
.change();
                                ...
                                <tr role="row" class="odd">
                                  ...
                                  <input name="theid[]" type="checkbox" id="theid[]" value="<?php echo $row['id']; ?>"></td>
                                  <td><?php echo $row['id']; ?></td>
                                  <td><?php echo $rowprovider['code']; ?></td><td><?php echo $rowprovider['name']; ?></td><td><?php echo $rowcurrency['pre'].' '.$rowcurrency['symbol'].''.number_format($row['payment'], 2); ?></td><td><?php echo $rowprovider['term']; ?> días</td><td><?php echo $rowstage['content']; ?> 
						...
						<p>
							...
							NOTA: No hay pagos liberados con las caracteristicas de este grupo.
                                ...
                                <?php if($num > 0){ ?> <div class="form-actions right">
											...
											<div class="col-md-4"><input name="schedule" type="text" class="form-control form-control-inline date-picker" id="schedule<?php echo $table; ?>[]" value=""></div>
                                            	<button type="submit" class="btn blue"><i class="fa fa-check"></i> Programar</button>
...
<script>
function validateForm<?php echo $table; ?>(){
var schedule = document.getElementById("schedule<?php echo $table; ?>[]").value;
if(schedule == ''){
	alert('No se puede programar pagos sin ingresar la fecha.');
	document.getElementById("schedule<?php echo $table; ?>[]").focus();
	return false;
}
