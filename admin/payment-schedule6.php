...
if($currency != ""){
	$get_string2 = '&currency='.$_GET['currency'];
...
$sql9 = ""; 
if($_GET['provider'] != ""){
	$get_string9 = '&provider='.$_GET['provider'];
	$inner_providers = 1;
...
$sql10 = "";
if($_GET['worker'] != ""){
	$get_string10 = '&worker='.$_GET['worker'];
	$inner_workers = 1;
...
$get_string = $get_string1.$get_string2.$get_string3.$get_string4.$get_string5.$get_string6.$get_string7.$get_string8.$get_string9.$get_string10.$get_string11.$get_string12.$get_string13.$get_string14.$get_string15.$get_string16.$get_string17.$get_string18;	
...
$sql = $sql1.$sql2.$sql3.$sql4.$sql5.$sql6.$sql7.$sql8.$sql9.$sql10.$sql11.$sql12.$sql13.$sql14.$sql15.$sql16.$sql17.$sql18;
								...
								$query = "select payments.id, payments.btype, payments.provider, payments.collaborator, payments.currency, payments.payment, payments.expiration, payments.description, payments.blockschedule from payments".$inner." where ((payments.status = '9') or (payments.status = '13.02') or (payments.status = '13.03')) and payments.sent_approve = '1'".$sql." group by payments.id order by payments.expiration asc";
...
<div class="col-md-3">                       <select name="bank" class="form-control" id="bank" style="margin-top:1px;">
