...
$query1 = "select payments.id, payments.btype, payments.provider, payments.collaborator, payments.currency, payments.payment, payments.bank, payments.status, payments.reference, payments.cnumber from payments".$join." where payments.id > 0".$sql." group by times.payment limit ".$inicio.",".$tampagina; 
