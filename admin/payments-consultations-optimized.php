...
<div class="col-md-4">
 ...
 <?php $queryproviders = "select id, code, first, last from workers order by first,last";
										...
										<?php if(($_SESSION['admin'] == "active") or ($_SESSION['dch'] == "active") or ($_SESSION['globalsearch'] == "active")){ ?>	<div class="col-md-4">
...
<?php if(($_SESSION['admin'] == "active") or ($_SESSION['dch'] == "active") or ($_SESSION['globalsearch'] == "active")){ ?>	<div class="col-md-4">
 ...
 <?php $queryproviders = "select code, code2, name from units order by code";
											$resultproviders = mysqli_query($con, $queryproviders);
...
<br><br>
                    ...
                    <div class="note note-regular">
                    <a href="payments-consultations-optimized.php">Mostrar filtro</a>
                    </div>
                    <div class="portlet">
...
$join2 = "";
if($jointimes == 1){
	$join2 = " inner join times on payments.id = times.payment";
}
$join3 = "";
if($joinbatch == 1){
	$join3 = " left join batch on payments.id = batch.payment";
}
...
$sql = $sql1.$sql2.$sql3.$sql4.$sql5.$sql6.$sql7.$sql8.$sql9.$sql10.$sql11; 
	...
	$query1 = "select payments.id, payments.btype, payments.provider, payments.collaborator from payments inner join bills on payments.id = bills.payment inner join times on payments.id = times.payment left join batch on payments.id = batch.payment where payments.id > 0".$sql." group by times.payment limit ".$inicio.",".$tampagina; 
