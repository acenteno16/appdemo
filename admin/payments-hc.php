...
<i class="icon-basket"></i>
							<a href="#">Solicitudes de Pagos CH</a>
			...
			<div class="row">
				...
				<div class="col-md-12"><!-- Begin: life time stats -->
					...
					<span><i class="fa fa-list"></i> Documentos</span></a>
								
								<a href="payment-hc-templates.php"  class="btn default blue-stripe">
					<span><i class="fa fa-list"></i> Plantillas</span></a>
								
								<a href="payment-order-hc-add.php"  class="btn default blue-stripe">
					<span><i class="fa fa-plus"></i> Agregar solicitud</span></a>
...
$query = "select * from payments where userid = '$_SESSION[userid]' and hc = '1' and child = '0' and status != '7.14'".$sql." order by id desc";
...
$query1 = "select * from payments where userid = '$_SESSION[userid]' and hc = '1' and child = '0' and status != '7.14'".$sql." order by id desc limit ".$inicio.",".$tampagina;  
