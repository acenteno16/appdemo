		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Remisiones <small>Creación de remisiones a Provision</small> 
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								...
								Seleccione los pagos que desea adjuntar a esta remisión
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								*/
								$query = "select payments.* from payments inner join times on payments.id = times.payment where times.userid = '$_SESSION[userid]' and ((times.stage='8.00') or (times.stage='8.01')) and payments.approved = '1' and payments.sent = '1' group by payments.id";
								//Rep 5 Oct
								$query = "select payments.* from payments inner join times on payments.id = times.payment where times.userid = '$_SESSION[userid]' and ((times.stage='8.00') or (times.stage='8.01')) and payments.approved = '1' and payments.sent = '1' group by payments.id"; 
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
								...
								$theroute = $row['route'];
								if(strlen($theroute) == 4){
									$queryunit = "select * from units where code = '$theroute'";
								}else{
									$queryunit = "select * from units where code2 = '$theroute'";
								}
...
?></td><td><?php echo $rowstage['content']; ?> 
						...
						<p>
							...
							NOTA: No hay solicitudes pendientes de remisionar.
                            ...
                            <a href="payments-referrals.php"><label class="btn blue">
