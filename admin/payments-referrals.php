		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Remisiones <small>Remisiones ea Provisión</small> 
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
                        ...
                        <li>
							...
							<a href="#">Remisiones a Provisión</a>
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="payments-referrals-add.php" class="btn default blue-stripe">
						...
						<div class="portlet-body">
							...
							<div class="table-container">
								...
								<?php $query = "select * from packages where userid = '$_SESSION[userid]' order by id desc";
