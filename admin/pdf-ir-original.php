...
for($c=0;$c<sizeof($id);$c++){
  ...
  $pdf->Image($urlRetention,0,0+$jump,210,100,'','');
  ...
  */
  ...
  $pdf->SetXY(133, 14+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$number); 
  
  //Day
  $pdf->SetXY(138,20+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$today[2]);
  //Month
  $pdf->SetXY(149,20+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$today[1]);
  //Year
  $pdf->SetXY(157,20+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$today[0]);
  
  //payment id
  $pdf->SetXY(186,20+$jump); 
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$row['id']);
  
  //Route
  $pdf->SetXY(174,14+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$row['route']);
  
  //Cheque PK
  $pdf->SetXY(195,14+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$row['cnumber']);
  
  //Provider
  $pdf->SetXY(34,31+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,utf8_decode($proname));
  
  //Address
  $pdf->SetXY(34,35+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,utf8_decode($proaddress));
  
  //Cedula
  $pdf->SetXY(97,39+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$pid);  
  
  //Bills
  $pdf->SetXY(72,42+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  //$pdf->Write(3,$billnumbers); 
  
  //Provider RUC
  $pdf->SetXY(29,39+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  $pdf->Write(3,$proruc);
  
  //% ret
  $pdf->SetXY(162,39+$jump);
  $pdf->SetFont('Arial','B',9);
  $pdf->SetTextColor(0,0,0);
  ...
  $newfilename='retenciones-ir-original.pdf';
