...
$query = "select * from cobrador where id_cobrador = '$id'";
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Cobradores <small>Editor de Cobradores</small>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="cobradores.php">Cobradores</a>
									...
									<div class="col-md-9">
										...
										<div class="row">
											...
											<div class="col-md-8 profile-info">
											  ...
											  <h1><?php echo $row['nombre_cobrador']." ".$row['apellido_cobrador']; ?></h1>
									...
									<div class="col-md-9">
										...
										<div class="tab-content">
											...
											<div id="tab_1-1" class="tab-pane active">
												...
												<form role="form" action="cobradores-editor-codigo.php" enctype="multipart/form-data" method="post" ><input name="id" type="hidden" value="<?php echo $row['id_cobrador']; ?>">

	<div class="col-md-6">												<div class="form-group">

														<label class="control-label">Nombre</label>

														<input name="nombre" type="text" class="form-control" id="nombre"  value="<?php echo $row['nombre_cobrador']; ?>"/>
													...
													<div class="col-md-6"><div class="form-group">
														...
														<input name="apellido" type="text" class="form-control" id="apellido"  value="<?php echo $row['apellido_cobrador']; ?>"/>
		...
		<div class="col-md-6">											<div class="form-group">
														...
														<input name="telefono" type="text" class="form-control" id="telefono"  value="<?php echo $row['telefono_cobrador']; ?>"/>
													...
													<div class="col-md-6"><div class="form-group">
														...
														<input name="sello" type="text" class="form-control" id="sello"  value="<?php echo $row['sello_cobrador']; ?>"/>
													...
													<div class="col-md-6"><div class="form-group">
														...
														<select name="activo" class="form-control" id="activo">
																...
																<option value="0" <?php if($row['cobrador_activo'] == 0) echo 'selected'; ?>>No</option>
													...
													<div class="col-md-6"><div class="form-group">
														...
														<label class="control-label">Centro de recaudo</label>
														<select name="centro" class="form-control" id="centro">
														  <option value="0" selected>Seleccionar</option>
<?php $querycentro = "select * from centro_recaudo";
$resultcentro = mysqli_query($con, $querycentro);
while($rowcentro=mysqli_fetch_array($resultcentro)){
?>                                                          <option value="<?php echo $rowcentro['id_centro']; ?>" <?php if($row['id_centro'] == $rowcentro['id_centro']) echo 'selected'; ?>><?php echo $rowcentro['nombre_centro']; ?></option>
<?php } ?>													  </select>
													</div></div>
                                                    					<div class="col-md-6"><div class="form-group">
														...
														<input name="salario" type="text" class="form-control" id="salario"  value="<?php echo str_replace('.00','',$row['salario_cobrador']); ?>"/>
											...
											<?php /*<div id="tab_3-3" class="tab-pane">
