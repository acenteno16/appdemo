		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Perfiles <?php //<small>Ordenes de pago</small> ?>
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								...
								<i class="fa fa-list"></i>Lista de Perfiles</div>

							<div class="actions">

								<a href="profiles-add.php" class="btn default blue-stripe">
...
while($row=mysqli_fetch_array($result)){
    $rowType=mysqli_fetch_array(mysqli_query($con, "select name from usertypes where id = '$row[type]'")); 
...
?>
                                ...
                                <tr role="row" class="odd <?php if($red == 1) echo 'newred'; ?>">
                                  ...
                                  <td><a href="profiles-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-warning">
