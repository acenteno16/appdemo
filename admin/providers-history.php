		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Proveedores <small>Historial de carga</small> 
...
$query = "select * from providers_excel order by id desc";
$result = mysqli_query($con, $query);
	   ...
	   ?>
                                ...
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?></td><td>
								<?php  echo $rowcollaborator['first']." ".$rowcollaborator['last']; ?>                              </td><td><?php 
								
								
									echo date('d-m-Y',strtotime($row['today']));	
...
?> </td><td><?php echo $row['now']; ?> 
									
							
								
							</td><td>
                            
                            <a href="providers-history-download.php?filename=<?php echo $row['filename']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-save"></i> Descargar</a>
