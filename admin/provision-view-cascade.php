			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					   	...
					   	<form action="provision-view-cascade-code.php" name="provisionForm" id="provisionForm" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
...
$querycompany = "select * from units where code = '$row[route]' or code2 = '$row[route]'";
...
echo $queryhalls = "select * from halls where company = '$rowgcompany[company]'"; 
