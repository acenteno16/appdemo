...
$mytotalstotal = 0;
$myniototalstotal = 0;
$queryaccountmaker0 = "select * from bills where payment = '$row[id]'"; 
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="provision-covid.php">Provision COVID</a>
				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
							...
							<div class="actions">
								...
								<?php
								$visor = isset($_GET['visor']) ? intval($_GET['visor']) : 0;
					   	...
					   	<form action="provision-view-covid-code.php" name="provisionForm" id="provisionForm" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();"> 
									<?php 
...
<div class="col-md-3 ">
													  <div class="form-group">
                                                        ...
                                                        <input name="retention1" type="text" class="form-control" id="retention1" value="<?php #echo $row['ret1']; ?>" placeholder="%" onKeyUp="javascript:reloadNumbers();" onkeypress="return justNumbers(event);" ><span class="input-group-addon bootstrap-touchspin-postfix">%</span>
...
<div class="col-md-3 ">
           ...
           <label>&nbsp;</label>                                             <input name="retention1ammount" type="text" class="form-control" id="retention1ammount" placeholder="Monto" value="<?php #echo $row['ret1a']; ?>" readonly>
...
<div class="col-md-3 ">
													  <div class="form-group">
														<label>IR C$:</label>
                                                        <input name="retention2" type="text" class="form-control" id="retention2" value="<?php #echo $row['ret2']; ?>" placeholder="%" onKeyUp="javascript:reloadNumbers();" onkeypress="return justNumbers(event);" ><span class="input-group-addon bootstrap-touchspin-postfix">%</span>
...
<div class="col-md-3 ">												  <div class="form-group">Asume GCP (IR).
                       ...
                       <!--/row-->
                                              ...
                                              <div class="col-md-3 ">												  <div class="form-group">Rets. Manuales<label>:</label>
                                                        <input name="retainer4" type="checkbox" id="retainer4" onChange="javascript:reloadManualRets();" value="1" <?php if($row['manualrets'] == 1) echo 'checked'; ?>>   
                                       <script>
...
if (node.parentNode) {
  node.parentNode.removeChild(node);
          ...
          <div class="col-md-6 " >  <button type="button" class="btn blue" id="notesButton"><i class="fa fa-check"></i> Ingresar notas de debito</button> 
		 ...
		 $('#notesButton').click(function(){
          ...
          <input name="paymentadj2" type="hidden" id="paymentadj2" value="<?php echo $_GET['id']; ?>"> <button type="button" class="btn red" id="notesButton2"><i class="fa fa-times"></i> Eliminar notas de debito</button> 
...
<div class="row"></div><br><br>
		 ...
		 $('#commissionButtonDelete').click(function(){
             window.location = "provision-commission-delete.php?id=<?php echo $_GET['id']; ?>";
		 }); 
		  </script>
...
<div class="col-md-3 ">
			    ...
			    <label>No. Batch:</label>
                                        ...
                                        <input name="nobatch[]" type="text" class="form-control" id="nobatch1" placeholder="" value="">
...
<?php //link documento ?>                                               
			    ...
			    <label>Link del Documento:</label>
														...
														<select name="linkdocument[]" class="form-control  select2me" id="linkdocument[]" data-placeholder="Seleccionar..."> 
...
if($row['ret1a'] > 0){
	...
	$querycompany = "select companies.id from companies inner join units on companies.code = units.companyCode where units.id = '$row[routeid]'"; 
...
*/ ?>
  ...
  <div class="col-md-12 "><div class="form-actions right">
    ...
    <p>
			...
			window.location="provision-view-deny.php?id=<?php echo $row['id']; ?>&reason="+reason+"&reason2="+reason2+'&covid=1'; 
		}else{
