...
while($rowrtype=mysqli_fetch_array($resultrtype)){
	...
	$str_family.='<optgroup label="'.$rowrtype['name'].'">'; 
	...
	while($rowrtypec=mysqli_fetch_array($resultrtypec)){
		...
		$str_family.='<option value="'.$rowrtypec["id"].",".$rowrtypec["percentage"].'">'.$rowrtypec["code"].' | '.str_replace(".00","",$rowrtypec["percentage"])."%"." - ".$rowrtypec["name"].'</option>'; 
...
<? 
#BILLS START
$querypbills = "select * from bills where payment = '$row[id]'";
...
<div class="row">
<div class="col-md-12"><h4>Documento No. <? echo $rowpbills['number']; ?></h4></div> 
<input type="hidden" id="documentid" name="documentid" value="<? echo $rowpbills['id']; ?>">
</div>    
<? ###########################################Start Family ?>

<? 

switch($rowpbills['currency']){
		case 1:
		$curr = "C$";
		break;
		case 2:
...
<div class="col-md-2">
	<input type="text" class="form-control" value="<? echo $rowpbills['number'] ?>" readonly>
</div>
<div class="col-md-2"> 
	<input type="text" class="form-control" value="<? echo $curr.str_replace('.00','',number_format($rowpbills['ammount'], 2)); ?>" readonly>
</div>
...
<input name="billretid[]" id="billretid[]" value="<? echo $rowpbills['id']; ?>" type="hidden">
</div>
...
<div class="col-md-3 ">
			    ...
			    <label>No. Batch:</label>
                                        ...
                                        <input name="nobatch_<? echo $rowpbills['id']; ?>[]" type="text" class="form-control" id="nobatch_<? echo $rowpbills['id']; ?>[]" placeholder="" value="">
...
<div class="col-md-3 ">
			    ...
			    <label>No. Documento:</label>
                                        ...
                                        <input name="nodocument_<? echo $rowpbills['id']; ?>[]" type="text" class="form-control" id="nodocument_<? echo $rowpbills['id']; ?>[]" placeholder="" value="">
...
<div class="col-md-6 " id="repairThis">
			    ...
			    <label>Link del Documento:</label>
                                                    ...
                                                    <select name="linkdocument_<? echo $rowpbills['id']; ?>[]" class="form-control  select2me" id="linkdocument_<? echo $rowpbills['id']; ?>[]" data-placeholder="Seleccionar..." onChange="">  
...
<div id="batchwaiter_<? echo $rowpbills['id']; ?>">
</div>
<div class="col-md-3 ">
<button type="button" class="btn blue" onClick="addBatch_<? echo $rowpbills['id']; ?>();">+</button>&nbsp;<button type="button" class="btn blue" onClick="openFiles();"><i class="fa fa-search"></i> Ver archivos</button>
<script>
 function openFiles(){
 ...
 <script type="text/javascript">
var noBatch = 1;
function addBatch_<? echo $rowpbills['id']; ?>(){
   var newBatch = '<div class="row" id="batch_<? echo $rowpbills['id']; ?>'+noBatch+'"><div class="col-md-3"><div class="form-group"><input name="nobatch_<? echo $rowpbills['id']; ?>[]" type="text" class="form-control" id="nobatch_<? echo $rowpbills['id']; ?>[]" placeholder="" value=""></div></div><div class="col-md-3 "><div class="form-group"><input name="nodocument_<? echo $rowpbills['id']; ?>[]" type="text" class="form-control" id="nodocument_<? echo $rowpbills['id']; ?>[]" placeholder="" value=""></div></div><div class="col-md-5 "><div class="form-group"><select name="linkdocument_<? echo $rowpbills['id']; ?>[]" class="form-control  select2me" id="linkdocument_<? echo $rowpbills['id']; ?>[]" data-placeholder="Seleccionar..." onChange=""><option value=""></option><?php 
$queryfbox = "select * from filebox where user = '$_SESSION[userid]' order by id desc limit $global_limit"; 
$resultfbox = mysqli_query($con, $queryfbox);
while($rowfbox=mysqli_fetch_array($resultfbox)){
?><option value="<?php echo 'http://getpay.casapellas.com.ni/admin/visor.php?key='.$rowfbox['url']; ?>"><?php echo $rowfbox['id']." | ".$rowfbox['title']; ?></option><?php } ?></select></div></div><div class="col-md-1 "><div class="form-group"><button type="button" class="btn red" onclick="javascript:deleteRowBatch_<? echo $rowpbills['id']; ?>('+noBatch+');">-</button></div></div></div>';
     noBatch++; 
	 $("#batchwaiter_<? echo $rowpbills['id']; ?>").append(newBatch);
...
function deleteRowBatch_<? echo $rowpbills['id']; ?>(id){
	//document.getElementById("distribution"+id).style.display = 'none';
	var node = document.getElementById("batch_<? echo $rowpbills['id']; ?>"+id);
if (node.parentNode) {
  node.parentNode.removeChild(node);
}
}
