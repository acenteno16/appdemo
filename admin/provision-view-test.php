				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
							...
							<div class="actions">
								...
								<?php if($_GET['visor'] == 1){ ?>
                                <a href="?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
                                ...
                                <?php }else{ ?>
                                <a href="?id=<?php echo $_GET['id']; ?>&visor=1" class="btn default blue-stripe">
...
<div class="col-md-12 " ><br><br>
 ...
 <div class="col-md-12 " >
   ...
   <p>- Las notas de débito deben de ser un valo positivo.<br>
     - Las ntas deben de ser ingresadas en la moneda de pago. (Moneda del campo monto a pagar)
     <br>
<br>
</p>
 </div>
