...
if($row['btype'] == 1){
	...
	echo $pcurrency2pay = $rowprovider['currency'];
}else{
								...
								<div class="portlet box blue">
                                    ...
                                    <div class="col-md-3 ">    
                                        ...
                                        <div class="col-md-9 ">
                                         ...
                                         <a href="javascript:recalculateRetention(3);" class="btn btn-xs default btn-editable" id="recalculate3"><i class="fa fa-retweet"></i> Notas de débito</a> * Nota de crédito emitida por el proveedor es un débito en el código del proveedor (Pasivo).
...
<h3 class="form-section">Ajustar Retenciones <span style="color:#D70003;">(En mantenimiento)</span></h3>
...
<div class="row" ><!--/span-->
          ...
          <input name="dspayment" type="hidden" id="dspayment" value="<?php echo $pbtype; ?>">  
...
<form id="notes" action="provision-notes-add.php" method="post" enctype="multipart/form-data"> 
 <div class="row" ><!--/span-->
 
 <div class="col-md-12 " ><h3 class="form-section">Ingresar notas de debito</h3></div>
...
<div class="col-md-3 " > 
                                              ...
                                              <div class="col-md-3 " > 
													  <div class="form-group" >
                                                        ...
                                                        <input name="noteammount[]" type="text" class="form-control" id="noteammount[]" placeholder="Monto de la nota">
                                                        <br>
...
if (node.parentNode) {
  node.parentNode.removeChild(node);
          ...
          <div class="col-md-3 " >  <button type="submit" class="btn blue"><i class="fa fa-check"></i> Ingresar notas de debito</button> 
