...
<div class="col-md-4">							
                            ...
                            function resetFilter(){
                            	window.location = "provisionCIC.php";
                            }
                            </script>
                    ...
                    <div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">
								...
								<? echo $num; ?> Solicitudes pendiente de Provision CIC
...
if($num > 0){ 
	...
	</td><td><a href="provisionCICView<? if($row['parent'] > 0) echo "-cascade"; ?>.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a> </td></tr>  
    <?php } ?>
     </tbody>
    </table>
	</div></div>
	...
	<p>NOTA: Ninguna provisión CIC pendiente.</p>
	</div>
	<?php } ?>
