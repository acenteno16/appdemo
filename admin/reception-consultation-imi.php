...
for($c=0;$c<sizeof($units);$c++){
	...
	$foreach_units = " and (".$foreach_units.")";
				...
				if($global_hall == 1){
				  ...
				  <?php include("reception-consultation-filter.php"); ?> 
...
$sql11 = " and ((hallsretention.hall = '1') or (hallsretention.hall = '4'))";
if(($hall != 0) and ($hall != '')){
	$sql11 = " and hallsretention.hall = '$hall'";
} 
...
if(($_SESSION['email'] == 'jairovargasg@gmail.com') or ($_GET['echo'] == 1)){
	echo $querymain;
