	...
	$foreach_units = " and (".$foreach_units.")";
				 ...
				 /* if(($numhalls > 0) and (!isset($_GET['hall']))){ ?>
				  ...
				  <?php 
				  	...
				  	include("reception-consultation-filter.php"); 
				 ?>
...
$hall = $_GET['hall'];
$sql11 = " and ((payments.hall = '1') or (payments.hall = '4'))"; 
if($hall != 0){
	$sql11 = " and payments.hall = '$hall'";
} 
...
$querymain = "select irretention.id, payments.id from irretention ".$inner." where irretention.number > '0'".$sql; 
...
$querymain1 = "select irretention.payment, irretention.number, irretention.id, irretention.void, irretention.dsent, irretention.dsenttoday, irretention.dsenttotime from irretention ".$inner." where irretention.number > '0'".$sql." order by irretention.id desc limit ".$inicio.",".$tampagina; 
//inner join payments on irretention.payment = payments.id
