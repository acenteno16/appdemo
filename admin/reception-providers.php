...
<?
							   ...
							   if($gcp != ""){
								   ...
								   $sql7 = " and gcp = '$gcp_val'";
							   }
							   
							   $sql = $sql1.$sql2.$sql3.$sql4.$sql5.$sql6.$sql7; 
							   
							   $query = "select * from providers where id > 0".$sql; 
                                ...
                                <tr role="row" class="odd <? if($row['active'] == 0) echo "danger"; ?>"><td><?php echo $row['code']; ?></td><td><?php echo $row['name']; ?></td><td><?php echo $row['ruc']; ?></td><td><?php echo $row['term']; ?> día(s)</td>
                                  <td><?php 
								   ...
								   if($row['updated'] == 1) echo "Si"; 
								    ...
								    <td><?php /*<a href="providers-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>*/ ?> <a href="reception-providers-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><?php //<i class="fa fa-search"></i> ?> Editar</a></td></tr><?php } ?>
