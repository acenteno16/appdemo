...
if($num == 0){
	echo "<script>alert('No se encontró sobres con el id ingresado.'); history.go(-1);</script>";
	exit();
}
...
if($row['type'] == 1){
		...
		$queryprovider = "select * from workers where code = '$row[provider]'";
		$resultprovider = mysqli_query($con, $queryprovider);
		$rowprovider = mysqli_fetch_array($resultprovider);
		$name_provider = $rowprovider['first']." ".$rowprovider['last'];
		$title_provider = "Colaborador";
	}
?>
<!DOCTYPE html>
							...
							<div class="tab-pane" id="tab_1">
								...
								<?php ?>
									...
									<div class="portlet-body form">
										...
										<form action="reception-retention-envelope-return-code.php" class="horizontal-form" method="post" enctype="multipart/form-data">
											...
											<div class="form-body"> 
												...
												<div class="row"><!--/span-->
												  ...
												  <div class="col-md-12 ">
												  <p>ID de Sobre: <? echo $row['id']; ?><br>
												   <? echo $title_provider; ?>: <? echo $name_provider; ?>	</p>
													  <div class="form-group">
														<label>Motivo de regresión:</label>
