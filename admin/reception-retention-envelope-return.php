		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Remisiones de Retenciones <small>Regresar Sobre </small>
							...
							<div class="tab-pane" id="tab_1">
								...
								<?php ?>
									...
									<div class="portlet-body form">
										...
										<form action="reception-retention-envelope-return-detail.php" class="horizontal-form" method="get" enctype="multipart/form-data">

											<div class="form-body">

												<h3 class="form-section">Regresar Sobre</h3>
				...
				<div class="col-md-12"><!-- Begin: life time stats -->
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">Sobres regresados</div>
<div class="actions">
