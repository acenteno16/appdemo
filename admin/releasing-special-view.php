		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Liberción Especial <small> Visor</small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="releasing-special.php">Liberación Especial</a>
        ...
        <?php } ?>
                            ...
                            */ ?>
							...
							function unlockRelease(){
								window.location = "releasing-special-unlock.php?id=<?php echo $_GET['id']; ?>";
							} 
							</script>
								<?php if($_GET['visor'] == 1){ ?>
                                <a href="releasing-special-view.php?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
                                ...
                                <?php }else{ ?>
                                <a href="releasing-special-view.php?id=<?php echo $_GET['id']; ?>&visor=1" class="btn default blue-stripe">
                            ...
                            <div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="releasing-special-view-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
