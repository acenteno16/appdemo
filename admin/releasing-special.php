		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Liberación Especial <? //<small>Liberación de solici</small> ?>
...
<div class="col-md-4">							
                            ...
                            window.location = "releasing-special.php";
...
<? } else{ ?>
<div class="note note-regular">
<a href="releasing-special.php?filter=1">Mostrar filtro</a>
</div>
<? } ?>
			<!-- END PAGE HEADER-->
...
$query = "select payments.id from payments  ".$join." where payments.status = '8' and payments.d_approve = '1' and payments.aprovision = '1' and payments.approved = '1'".$sql.$andor." group by payments.id order by payments.expiration asc"; 
   
$result = mysqli_query($con, $query);
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);  

$query1 = "select payments.id, payments.parent, payments.btype, payments.provider, payments.collaborator, payments.intern, payments.client, payments.currency, payments.payment, payments.expiration, payments.blockrelease, payments.d_approve from payments".$join." where child = '0' and payments.d_approve = '1' and payments.status = '8' and payments.aprovision = '1' and payments.approved = '1' and payments.btype != '4'".$sql.$andor." group by payments.id order by payments.immediate desc, payments.expiration asc limit ".$inicio.",".$tampagina;   
...
?></td><td><?php 
                           ...
                           if(($rowstatus['stage2'] != "0.00") and ($rowstatus['stage2'] != "")){  
							...
							if(($row['blockrelease'] == "")){ ?>
                            <a href="releasing-special-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a> <?php }
							else{  
							
							$queryuser = "select first, last from workers where code = '$row[blockrelease]'";
                 ...
                 <li>
										<a href="releasing-special.php?page=<?php echo $previous.$chain; ?>&form=1">
  ...
  for ($i=1;$i<=$totpagina;$i++){ 
        if ($pagina == $i){
		  ...
		  echo '<li><a href="releasing-special.php?page='.$i.$chain.'&form=1">'.$i .'</a></li>'; 
		}
    } } ?>
             <?php if($next != ""){ ?>
                 ...
                 <li>
										<a href="releasing-special.php?page=<?php echo $next.$chain; ?>&form=1">
										<i class="fa fa-angle-right"></i>
										</a>
									</li>
                  <?php } ?>
						...
						<p>
							...
							NOTA: Ninguna liberación especial pendiente.
						</p>
