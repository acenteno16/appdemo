...
$queryprovisioned = "select payments.* from payments inner join times on payments.id = times.payment where (times.stage = '8') and times.today >= '$fmtoday' and payments.approved = '1' and payments.aprovision = '1' group by times.payment";
