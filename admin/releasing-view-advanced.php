...
<br>
        ...
        <?php } ?>
						...
						<h3 class="form-section">Solicitudes	<div class="actions" style="float:right;">

								<a href="releasing-view-advanced.php" class="btn default blue-stripe">

								<i class="fa fa-plus"></i>

								<span class="hidden-480">

								Vista con Archivos</span>
