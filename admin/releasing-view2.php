...
<br>
        ...
        <?php } ?>
							...
							<div class="actions">
								...
								<?php if($_GET['visor'] == 1){ ?>
                                <a href="releasing-view.php?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
                                ...
                                <?php }else{ ?>
                                <a href="releasing-view.php?id=<?php echo $_GET['id']; ?>&visor=1" class="btn default blue-stripe">
