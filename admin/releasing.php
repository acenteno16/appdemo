...
<div class="col-md-3">
 ...
 <?php $queryproviders = "select * from companies order by name";
                                                          ...
                                                          function loadProviders(value){
                                                              if(value == 'load'){
                                                                  ...
                                                                  $.post("reloadContent.php", { type: 'providersMenu' }, function(data){
                                                                      ...
                                                                      $("#provider").select2('data', { id:"0", text: "Todos los Proveedores"});
                                                              ...
                                                              if(value == 'load'){
                                                                  ...
                                                                  $.post("reloadContent.php", { type: 'workersMenu' }, function(data){
                                                                    document.getElementById("worker").innerHTML = data;
                                                                      $("#worker").select2('data', { id:"0", text: "Todos los Colaboradores"});
            ...
            <div class="portlet-body">
							...
							<div class="table-scrollable">
								...
								<tr role="row" class="heading">
                                    ...
                                    <th width="15%">Tipo de beneficiario</th>

									<th width="8%">Total Pagar</th>
...
$sql7 = "";
if($_GET['company'] != ""){
$sql7 = " and payments.company = '$_GET[company]'";
$chain = "&company=".$_GET['company'];
}
...
$sql = $sql0.$sql1.$sql2.$sql3.$sql4.$sql5.$sql7;  
...
$query1 = "select payments.id, payments.parent, payments.btype, payments.provider, payments.collaborator, payments.intern, payments.client, payments.currency, payments.payment, payments.expiration, payments.blockrelease, payments.d_approve, payments.company, payments.userid from payments".$join." where child = '0' and payments.status = '8' and payments.aprovision = '1' and payments.approved = '1' and payments.btype != '4'".$sql.$andor." group by payments.id order by payments.immediate desc, payments.expiration asc limit ".$inicio.",".$tampagina;   
...
<a href="#" class="btn default blue-stripe" onclick="unlockRelease(<?php echo $row['id']; ?>);"><i class="fa fa-unlock"> <?php echo $row['id']; ?></i></a>
								...
								?>
									...
									<td><? if($row['d_approve'] == 1) echo '<img src="../images/flag-blue.png" width="13" alt=""/> '; ?><?php if($rowprovider['flag'] == 1) echo '<img src="../images/flag.png" width="13" alt=""/>'; echo $ben_name; ?></td>
                                    
                                    <td><? echo $benType[$row['btype']]; ?></td>
                                    <td><?php echo $rowcurrency['pre'].' '.$rowcurrency['symbol'].''.str_replace('.00','',number_format($row['payment'], 2)); ?></td>
                                    <td><?php $date1 = date("Y-m-d");
							echo $date2 = date('d-m-Y',strtotime($row['expiration']));
