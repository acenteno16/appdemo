...
$query = "select payments.* from payments left join bills on payments.id = bills.payment where payments.status = '8' and payments.approved = '1'".$sql." group by payments.id order by payments.expiration asc";  
...
?></td><td><?php echo $rowstage['content']; ?> 
							...
							</td><td><a href="releasing-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a> </td></tr>
                                <?php } } else { ?>
