...
<div class="col-md-4">
 ...
 <?php $queryproviders = "select * from providers order by name";
											...
											?>
                                            <option value="<?php echo $rowproviders["id"]; ?>" <?php if($rowproviders["id"] == $_GET['provider'])echo 'selected'; ?>><?php echo $rowproviders["name"]; ?></option>
                                            <?php }
											?>
											...
											<div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
												...
												<input name="from" type="text" class="form-control" placeholder="desde" value="<?php echo $_GET['from']; ?>">

												<span class="input-group-addon">

												<i class="fa fa-angle-double-right"></i></span>

												<input name="to" type="text" class="form-control" placeholder="hasta" value="<?php echo $_GET['to']; ?>">
	...
	<label class="control-label">Solicitante:</label>
											...
											<select name="request" class="form-control  select2me" id="request" data-placeholder="Seleccionar...">
 ...
 <?php $queryencharged = "select * from workers";
											...
											?>
                                            <option value="<?php echo $rowencharged["code"]; ?>" <?php if($rowencharged["code"] == $_GET['request']) echo 'selected'; ?>><?php echo $rowencharged["first"]." ".$rowencharged['last']; ?></option>
                                            <?php }
											?>
                                                ...
                                                <div class="col-md-2 ">
													  <div class="form-group">
                                                        ...
                                                        <input name="payment" type="text" class="form-control" id="payment" value="<?php echo $_GET['payment']; ?>">
...
$sql4 = "";
if($request != ""){
$sql4 = " and payments.userid = '$request'";
}
$sql5 = "";
if($bill != ""){
...
$query = "select payments.* from payments inner join times on payments.id = times.payment inner join workers on times.userid = workers.code left join bills on payments.id = bills.payment where payments.id > 0".$sql.' group by payments.id'; 
