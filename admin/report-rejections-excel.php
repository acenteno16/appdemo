...
$thisStage = array();
$sql_reject = "";
$query_reject = "select id, name from stages where name2 = 'Rechazado'";
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Rechazos');
...
header('Content-Disposition: attachment;filename="Rechazos.xlsx"');
