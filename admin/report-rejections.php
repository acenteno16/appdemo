		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Rechazados</small> 
...
<form id="ungrouped" name="ungrouped" action="report-rejections-excel.php" enctype="multipart/form-data" method="post">
...
<div class="col-md-3">
	    ...
	    <label class="control-label">Rechazado por:</label>

		<select name="userid" class="form-control  select2me" id="userid" data-placeholder="Seleccionar...">
...
<br><br>
						<div class="col-md-2">							
						    ...
						    <input type="hidden" id="form" name="form" value="1"><button type="submit" class="btn blue"><i class="fa fa-file-excel-o"></i> Generar Reporte</button> 
												
                 </div> <div class="col-md-2">							

						    
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-repeat"></i> Eliminar Filtro</button>
                           
							<script>
							function goBack(){
								window.location = "report-rejections.php";
							}
							</script>
								...
								<p><br>
**El período máximo a reportar es de 12 meses.</p>
