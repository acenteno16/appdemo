		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Regresados</small> 
...
<form id="ungrouped" name="ungrouped" action="report-returned-excel.php" enctype="multipart/form-data" method="post">
...
<div class="col-md-3">
	    ...
	    <label class="control-label">Regresado por:</label>
