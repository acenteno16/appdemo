					  ...
					  <li>
                        ...
                        <li>
                         ...
                         <li>
							...
							<a href="#">Ingreso a Banco por UN</a>
...
<form id="ungrouped" name="ungrouped" action="report-schedule-approve-un-code.php" enctype="multipart/form-data" method="post">
...
<div class="col-md-4">
 ...
 <?php 										$queryroutes = "select code, code2, name from units order by code";
											...
											?>
                                            <option value="<?php if($rowroutes['code2'] > 0){ echo $rowroutes['code2']; }else{ echo $rowroutes["code"]; } ?>"><?php if($rowroutes['code2'] > 0){ echo $rowroutes['code2']; }else{ echo $rowroutes["code"]; } echo ' | '.$rowroutes["name"]; ?></option> 
                                            <?php }
											?> 
...
<br><br>
						<div class="col-md-2">							
						    ...
						    <input type="hidden" id="form" name="form" value="1"><button type="submit" class="btn blue"><i class="fa fa-file-excel-o"></i> Exportar</button> 
