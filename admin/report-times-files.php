...
$sheet->setCellValue('AD1', 'Fecha_Remisionado');
$sheet->setCellValue('AE1', 'Fecha_Recibido_Recepcion');
$sheet->setCellValue('AF1', 'Fecha_entregado_a_tesoreria');
$sheet->setCellValue('AG1', 'Fecha_Almacenado');
...
while($row=mysqli_fetch_array($result)){
	...
	$sheet->setCellValue('AD'.$xlsRow, $dRem);
	$sheet->setCellValue('AE'.$xlsRow, $dRec);
	$sheet->setCellValue('AF'.$xlsRow, $dEnt);
	$sheet->setCellValue('AG'.$xlsRow, $dAlm);
