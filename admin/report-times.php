...
include("session-globaltimes-report.php"); 
                            ...
                            <div class="row">
								...
								<div class="col-md-4 ">
                                    <div class="form-group">
                                        ...
                                        <input name="request" type="text" class="form-control" id="request" value="<? if(isset($_GET['request'])) echo $_GET['request']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4" > 
											...
											<div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
												...
												<input type="text" class="form-control" name="from" placeholder="desde" value="<? if(isset($_GET['from'])) echo $_GET['from']; ?>">

												<span class="input-group-addon">

												<i class="fa fa-angle-double-right"></i></span>

												<input type="text" class="form-control" name="to" placeholder="hasta"  value="<? if(isset($_GET['to'])) echo $_GET['to']; ?>">
...
$sql7= "";
if($company != ""){
	$sql7 = " and payments.company = '$company'";
}
	
$sql8 = "";
if($immediate != ""){
	$sql8 = " and payments.immediate = '$immediate'";
}

$sql9 = "";
if($type != ""){
	if($type != 0){
	$sql9 = " and bills.type = '$type'";
	$join_bills = 1;
	}
}
...
if($concept != ""){
	if($concept != 0){
		$sql10 = " and bills.concept = '$concept'";
		$join_bills = 1;
	}
}
...
if($category != ""){
	if($category != 0){
		$sql11 = " and bills.category = '$category'";
		$join_bills = 1;
	}
}
...
if($join_workers == 1){
	$join2 = " inner join workers on times.userid = workers.code";
}	
if($join_bills == 1){
	$join3 = " inner join bills on payments.id = bills.payment";
}		
						...
						<p>
							...
							?>
                                ...
                                <? if($_GET['form'] == 1){ ?>
									...
									<form action="report-times-excel.php" method="post" enctype="multipart/form-data"> 
                               ...
                               <input type="hidden" name="join" value="<? echo $join; ?>">
								...
								<form action="report-times-files.php" method="post" enctype="multipart/form-data"> 
                            
                               <input type="hidden" name="sql" value="<? echo $sql; ?>"> 
                               <input type="hidden" name="join" value="<? echo $join; ?>">
                             
                                <button type="submit" class="btn green"><i class="fa fa-file-excel-o"></i> Exportar a excel [Files]</button>    
								</form>
								
								
								<? if(($_SESSION['email'] == 'hgaitan@casapellas.com') or ($_SESSION['email'] == 'jairovargasg@gmail.com') or ($_SESSION['email'] == 'mgutierrez@casapellas.com')){ ?>
									<form action="report-times-name.php" method="post" enctype="multipart/form-data"> 
                            
                               <input type="hidden" name="sql" value="<? echo $sql; ?>"> 
                               <input type="hidden" name="join" value="<? echo $join; ?>">
                             
                                <button type="submit" class="btn green"><i class="fa fa-file-excel-o"></i> Exportar a excel (Nombres)</button>   
								</form>
								
								
								<form action="reportTimesExcelRequest.php" method="post" enctype="multipart/form-data"> 
                            
                               <input type="hidden" name="sql" value="<? echo $sql; ?>"> 
                               <input type="hidden" name="join" value="<? echo $join; ?>">
                             
                                <button type="submit" class="btn green"><i class="fa fa-file-excel-o"></i> Exportar a excel Beta</button>   
								</form>
								<form action="reportTimesExcelRequestPrev.php" method="post" enctype="multipart/form-data"> 
                            
                               <input type="hidden" name="sql" value="<? echo $sql; ?>"> 
                               <input type="hidden" name="join" value="<? echo $join; ?>">
                             
                                <button type="submit" class="btn green"><i class="fa fa-file-excel-o"></i> Exportar a excel (en curso)</button>   
								</form>
								<? } ?>
