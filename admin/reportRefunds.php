<?php include("sessionsReportsRefunds.php"); ?> 
<!DOCTYPE html>
  ...
  <div class="page-content"> 
    ...
    <div class="row">
      <div class="col-md-12"><!-- Begin: life time stats -->
        <form id="ungrouped" name="ungrouped" action="reportRefundsCode.php" enctype="multipart/form-data" method="post">
              ...
              <div class="col-md-4">
                ...
                <script>
							function clearFilter(){
								window.location = "reportRefunds.php"; 
							}
							</script> 
              </div>
            </div>
