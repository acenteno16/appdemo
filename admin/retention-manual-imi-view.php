...
$query = "select * from retentionimi where id = '$id'";
...
<div class="page-container">
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Retenciones manuales IMI</a></li>
                             <i class="fa fa-angle-right"></i>

						<li>

							<a href="#">Ver Retención</a>
									...
									<div class="portlet-body form">
										...
										<form name="porder" id="porder" action="retention-manual-ir-add-code.php" class="horizontal-form" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
											...
											<div class="form-body">
												...
												<h3 class="form-section">Retenciones manuales IMI</h3> 
                                                <div class="row"><!--/span-->
	...
	<label class="control-label">No. de retención:</label>
											  ...
											  <input name="number" type="text" class="form-control" id="number" value="<?php echo $row['number']; ?>" disabled>  
                                                    ...
                                                    <div class="col-md-3">
													  ...
													  <div class="form-group">
														...
														<label class="control-label">Fecha:</label>
														 ...
														 <input name="today2" type="text" class="form-control form-control-inline date-picker" id="today2" value="<?php echo $row['today2']; ?>" readonly disabled>
									  ...
									  <input name="provider" type="text" class="form-control" id="provider" value="<?php echo $row['provider']; ?>" disabled> 
                                               ...
                                               <div class="col-md-12 ">
													  <div class="form-group">
                                                        ...
                                                        <textarea name="description" rows="2" class="form-control" id="description" disabled><?php echo $row['description']; ?></textarea> 
...
<div class="col-md-4">
									  ...
									  <input name="totalbill" type="text" class="form-control" id="totalbill" value="<?php echo $row['totalbill']; ?>" onKeyUp="javascript:calculateTotal();" onKeyPress="return justNumbers(event);" disabled>
...
<div class="col-md-4 ">
													  <div class="form-group">
                                                        ...
                                                        <input name="percent" type="text" class="form-control" id="percent" value="<?php echo $row['percent']; ?>" onKeyUp="javascript:calculateTotal();" onKeyPress="return justNumbers(event);" disabled></div>
													</div>
...
<div class="col-md-4 ">
													  <div class="form-group">
														<label>Total retención:</label> 
                                                                                                              <input name="totalretention" type="text" class="form-control" id="totalretention" value="<?php echo $row['totalretention']; ?>" readonly disabled> 
...
<div class="col-md-12 ">
													  <div class="form-group">
                                                        ...
                                                        <input name="letters" type="text" class="form-control" id="letters" value="" readonly disabled> 
