		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Retenciones Manuales <small>IMI</small> 
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Retenciones Manuales IMI</a>
                    ...
                    <div class="portlet">
						...
						Retenciones Manuales
                            ...
                            <div class="actions">
								...
								<a href="retention-manual-imi-add.php" class="btn default blue-stripe">

								<i class="fa fa-plus"></i>

								<span class="hidden-480">

								Nueva retención manual</span>
...
$querymain = "select * from retentionimi order by id desc";
...
$nummain = mysqli_num_rows($resultmain); 
							...
							echo $row['number']; 	  
                                  ...
                                  <td> <?php 
								 echo $row['totalretention']; 
								  ?>
                                    
</td>
                                
                                <td><a href="retention-manual-imi-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a>
...
<br>
 <div class="note note-danger">
						...
						<p>
							...
							NOTA: No hay ninguna retención manual.
