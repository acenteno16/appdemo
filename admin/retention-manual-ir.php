		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Retenciones Manuales <small>IR</small> 
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Retenciones Manuales IR</a>
                    ...
                    <div class="portlet">
						...
						Retenciones Manuales
                            ...
                            <div class="actions">
								...
								<a href="retention-manual-ir-add.php" class="btn default blue-stripe">
...
$querymain = "select * from retentionir order by id desc";
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
							...
							echo $row['number']; 	  
                                ...
                                <td><a href="retention-manual-ir-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a>
