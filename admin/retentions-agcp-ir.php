...
$sql = $sql4.$sql5; 
if($form == 1){						
$query = "select payments.* from payments inner join times on payments.id = times.payment where times.stage = '14.00' and payments.ret2a > '0' and payments.acp2 = '1'".$sql." group by times.payment"; 
...
if(($num > 0) and ($form == 1)){ ?> 
							   ...
							   $nioammount = $row['ret2a'];	
                                ...
                                <tr role="row" class="odd"> 
								 ...
								 echo $pre.str_replace('.00','',number_format($row['payment'],2)).$pos; ?><br>

</td>
                                
                                <td><?php 
								
								echo 'C$'.str_replace('.00','',number_format($row['ret2a'],2))." Cordobas";  
								$global_ret2a += $row['ret2a'];
								...
								?>
                                  ...
                                  <strong>Total AGCP:</strong> <?php echo 'NIO C$'.number_format($global_ret2a,2)." Córdobas"; ?>
