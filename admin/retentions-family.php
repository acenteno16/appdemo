				...
				<div class="col-md-12">
                   ...
                   <div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="retentions-family-add.php" class="horizontal-form" method="post" enctype="multipart/form-data">

											<div class="form-body"> 

												<h3 class="form-section">Agregar Familia de Retenciones</h3>
...
$query = "select * from retfamily order by id asc";
...
?>
                                ...
                                <tr role="row" class="odd">
                                  ...
                                  <td><a href="retentions-family-content.php?id=<?php echo $row['id']; ?>">
                                  <span class="label label-primary">
								  <i class="fa fa-search"> </i> Ver </span></a>
                                  &nbsp; <a href="javascript:deleteRetentionsFamily(<?php echo $row['id']; ?>);">
