		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Retenciones <small>Redireccionar retenciones IMI</small
				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <?php ///// table ?>
                            ...
                            <form action="retentions-generator-imi-global-view-rd-code.php" method="post" enctype="multipart/form-data"> 
<div class="row"><!--/span--> 
 ...
 <div class="table-scrollable">
                                ...
                                <?php 
									...
									$querymain = "select hallsretention.* from hallsretention where id = '$_GET[id]'"; 
							...
							$row = mysqli_fetch_array($result);
                                ...
                                <tr role="row" class="odd <?php if($row['imiprinted'] == 1) echo 'success';  if($rowmain['void'] == 1) echo ' danger' ?>">  
 ...
 echo date('d-m-Y',strtotime($rowretdate['today'])); 
                            ...
                            */ ?></tr>
                               ...
                               <select name="hall" id="hall">
                                 ...
                                 <? 
								 echo $queryfirst = "select halls.company from halls inner join hallsbook on halls.id = hallsbook.hall where hallsbook.serial = '$rowmain[serial]'"; 
								 $resultfirst = mysqli_query($con, $queryfirst);
								 $rowfirst = mysqli_fetch_array($resultfirst);
								 
								 $companyid = $rowfirst['company'];
								 
								 $querycompany = "select * from halls where company = '$companyid'";
...
<button type="submit" class="btn red"><i class="fa fa-check"></i> RD</button> <button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-reply"></i> Regresar</button>
<script>
function goBack(){
	history.go(-1);
}
