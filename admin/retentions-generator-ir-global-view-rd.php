				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <?php ///// table ?>
                            ...
                            <form action="retentions-generator-ir-global-view-rd-code.php" method="post" enctype="multipart/form-data"> 
<div class="row"><!--/span-->
...
?>
	  ...
	  ?>
                               ...
                               <select name="hall" id="hall">
                                 ...
                                 <? 
								 $queryfirst = "select * from halls where id = '$rowpayment[hall]'"; 
