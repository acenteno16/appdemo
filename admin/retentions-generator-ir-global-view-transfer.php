				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <?php ///// table ?>
                            ...
                            <form action="retentions-generator-ir-global-view-transfer-code.php" method="post" enctype="multipart/form-data"> 
<div class="row"><!--/span--> 
...
?>
	  ...
	  ?>
                               ...
                               <select name="hall" id="hall">
								 ...
								 $querycompany = "select * from halls";
...
<button type="submit" class="btn blue"><i class="fa fa-check"></i> Trasladar</button> <button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-reply"></i> Regresar</button>
<script>
function goBack(){
	history.go(-1);
}
