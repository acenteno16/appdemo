				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <?php ///// table ?>
                            ...
                            <form action="retentions-generator-ir-global-view-code.php" method="post" enctype="multipart/form-data"> 
<div class="row"><!--/span-->
...
<button type="submit" class="btn red"><i class="fa fa-times"></i> Anular + RD</button>  <button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-reply"></i> Regresar</button>
<script>
function goBack(){
	history.go(-1);
}
