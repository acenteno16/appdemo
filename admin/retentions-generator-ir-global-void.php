				...
				<div class="col-md-12">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <?php ///// table ?>
                            ...
                            <form action="retentions-generator-ir-global-void-code.php" method="post" enctype="multipart/form-data"> 
<div class="row"><!--/span-->
...
?>
     ...
     <p>Esta seguro de anular esta retención? Si usted desea anular esta retención, pulse el boton rojo con el texto "Anular". Una vez pulsado este botón, inmediatamente la retención quedará anulada sin ningún otro tipo de alerta. Si Usted no desea anular esta retencion pulse el boton azul "Regresar"</p>
