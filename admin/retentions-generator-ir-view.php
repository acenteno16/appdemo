                  ...
                  <div class="col-md-12"><!-- Begin: life time stats -->
                    ...
                    <div class="portlet-body">
                             ...
                             <form action="#" method="post" enctype="multipart/form-data" name="form2" id="form2"><div class="table-container">
								...
								//$query = "select payments.* from payments inner join bills on payments.id = bills.payment where payments.status >= '14' and payments.ret2a > '0'".$sql;
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
							...
							$row = mysqli_fetch_array($result);
								...
								//$queryret = "select * from irretention where payment = '$row[id]'";
                                  ...
                                  <td> <?php 
								  if($row['ret2a'] > 0){
								  echo 'C$'.str_replace('.00','',number_format($row['ret2a'],2)).' Cordobas'; $gret2a+=$row['ret2a'];
								  }else{
									  echo "NA";
								  }
								  ?>
...
<br><br>
                     <p><strong>Total Retenciones IR:</strong> C$<?php echo number_format($gret2a, 2); ?></p>                                         
						...
						<p>
							...
							NOTA:  No hay ninguna retención de IR en este grupo de cancelación.  
