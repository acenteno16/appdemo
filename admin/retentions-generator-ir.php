...
$querymain = "select payments.* from payments inner join bills on payments.id = bills.payment where	payments.id > '0' and payments.ret2a > '0'".$sql.' group by payments.id'; 
...
<div class="table-scrollable">
                                ...
                                <td><a href="retentions-generator-ir-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
