		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Retenciones <small>Atascadas</small> 
...
$querymain = "select payments.* from payments where payments.ret1a > '0' and payments.ret1id = '0' and payments.status = '14'";

	
								$resultmain = mysqli_query($con, $querymain);
								echo $nummain = mysqli_num_rows($resultmain);
								
								?> Retenciones atascadas IMI
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
                                ...
                                <tr role="row" class="odd <?php if($row['ret2a'] == 0) echo "warning"; ?>"> <td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                                  <input name="theid[]" type="checkbox" id="theid[]" value="<?php echo $row['id']; ?>" class="group-checkable" data-set="#datatable_orders .theid" onChange="calculateBalance(); " <?php if($row['ret2a'] == 0) echo "disabled"; ?>></td>
                                  <td><?php echo $row['id']; ?></td><td><?php echo $theprovider; ?></td>
                                  <td> <?php 
                                  ...
                                  <td> <?php 
								  if($row['ret1a'] > 0){
								  echo 'C$'.str_replace('.00','',number_format($row['ret1a'],2)).' Cordobas'; $gret1a+=$row['ret1a'];
								  }else{
									  echo "NA";
								  }
								  ?>
...
<button type="button" class="btn blue" onClick="javascript:pdfPrint();"><i class="fa fa-print"></i> Procesar</button>
...
$querymain = "select payments.* from payments where payments.ret2a > '0' and payments.ret2id = '0' and payments.status = '14'";
