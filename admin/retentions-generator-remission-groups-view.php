...
$query = "select * from mayorremission where id = '$id'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_array($result);        

$rowcollaborator = mysqli_fetch_array(mysqli_query($con, "select * from workers where code = '$row[userid]'"));
								
$queryrets = "select * from mayorremissioncontent where mayorremission = '$row[id]'";
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
								...
								while($rowmain2=mysqli_fetch_array($resultrets)){
									$querymain = "select * from hallsretention where id = '$rowmain2[mayorretention]'";
