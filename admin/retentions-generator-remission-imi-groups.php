					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="retentions-generator-imi2.php?hall=<? echo $_GET['hall']; ?>" class="btn default blue-stripe">

								<i class="fa fa-reply"></i>

								<span class="hidden-480">

								Regresar a la alcaldia</span>

								</a>
                                
                                <? /*<a href="retentions-generator-remission-imi.php?hall=<? echo $_GET['hall']; ?>" class="btn default blue-stripe">
...
if($_SESSION['admin'] == 'active'){
    ...
    $sqluser = " and userid = '$_SESSION[userid]'";
}

$query = "select * from hallsremission where id > '0'".$sqluser.$sql." order by id desc";
$result = mysqli_query($con, $query);
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);        


$query1 = "select * from hallsremission where id > '0'".$sqluser.$sql." order by id desc limit ".$inicio.",".$tampagina;  
...
if($numdev > 0){  ?>
								...
								$queryrets = "select id from hallsremissioncontent where hallsremission = '$row[id]'";
...
$rowstatus = mysqli_fetch_array(mysqli_query($con, "select * from mayorremissionstages where id = '$row[status]'"));
...
?> 
                            ...
                            <a href="retentions-generator-remission-imi-groups-view.php?id=<?php echo $row['id']; ?>&hall=<? echo $_GET['hall']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
