		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Retenciones IR <small>Remisiones</small> 
					...
					<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="retentions-generator-ir2.php?hall=<? echo $_GET['hall']; ?>" class="btn default blue-stripe">

								<i class="fa fa-reply"></i>

								<span class="hidden-480">

								Regresar a la sucursal</span>

								</a>
                                
                                <? 
								//OBSOLETE
								/*<a href="retentions-generator-remission-ir.php?hall=<? echo $_GET['hall']; ?>" class="btn default blue-stripe">

								<i class="fa fa-plus"></i>

								<span class="hidden-480">

								Crear Remisiones</span>
...
$query = "select * from irremission where userid = '$_SESSION[userid]'".$sql." order by id desc";
$result = mysqli_query($con, $query);
$numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);        


$query1 = "select * from irremission where userid = '$_SESSION[userid]'".$sql." order by id desc limit ".$inicio.",".$tampagina;
...
if($numdev > 0){  ?>
								...
								$queryrets = "select id from irremissioncontent where irremission = '$row[id]'";
								$resultrets = mysqli_query($con, $queryrets);
								$numrets = mysqli_num_rows($resultrets);
								
								?>
                                
                                <tr role="row" class="odd"><td class="sorting_1"><?php echo $row['id']; ?></td><td><?php  echo $rowcollaborator['code']." | ".$rowcollaborator['first']." ".$rowcollaborator['last']; ?></td><td><?php echo $row['today']; ?></td><td><? echo $numrets; ?></td><td><?php 
...
?> 
                            ...
                            <a href="retentions-generator-remission-groups-ir-view.php?id=<?php echo $row['id']; ?>&hall=<? echo $_GET['hall']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a> <? if(($row['status'] == 1)){ ?><a href="retentions-generator-remission-groups-ir-void.php?id=<?php echo $row['id']; ?>&hall=<? echo $_GET['hall']; ?>" class="btn btn-xs red btn-editable"><i class="fa fa-times"></i> Anular</a><? } ?> 
                 ...
                 <li>
                  ...
                  <?php } ?>
						...
						<p>
							...
							NOTA: No hay ninguna remisión vinculada a esta cuenta.
