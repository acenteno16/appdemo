					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
                        ...
                        <li>
							...
							<a href="withholding-mayor-tax.php">IR</a>
...
$querymain = "select irretention.id, payments.id from irretention ".$inner." where payments.hall = '$hall' and irretention.number > '0' and irretention.remissionstatus = '0'".$sql; 
...
$querymain1 = "select irretention.payment, irretention.number, irretention.id from irretention ".$inner." where irretention.number > '0' and payments.hall = '$hall' and irretention.remissionstatus = '0'".$sql." order by irretention.id desc limit ".$inicio.",".$tampagina; 
//inner join payments on irretention.payment = payments.id
