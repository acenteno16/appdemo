					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
                        ...
                        <li>
                            ...
                            <a href="retentions-ir-authorized.php?company=<? echo $rowcompany['id']; ?>"><? echo $rowcompany['name']; ?></a>
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-title">
			 						...
			 						<div class="portlet-body form">
										...
										<form action="retentions-ir-authorized-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers"> 
						   ...
						   <div class="form-group">
							 <label>Autorizado:</label>
                                                        <input name="authorized" type="text" class="form-control" id="authorized" >
                       ...
                       <!--/row-->
                        ...
                        <!--/row--></div>
                                                    ...
                                                    <div class="col-md-4 ">
						   <div class="form-group">
							 <label>Plasmar desde:</label>
                                                        <input name="today2" type="text" class="form-control date-picker" id="today2" readonly>
                       ...
                       <!--/row-->
                        ...
                        <!--/row--></div>
                                  ...
                                  <? /* <div class="col-md-4 ">  <div class="form-group">
                                   ...
                                   </div>*/ ?><input type="hidden" name="company" id="company" value="<? echo $_GET['company']; ?>">
                       ...
                       <!--/row-->
                        ...
                        <!--/row--></div>
											...
											<div class="form-actions right">
                                                ...
                                                <script>
                                                function goBack(){
                                                    window.location = "retentions-ir-authorized.php";
                                                }
                                                </script>
