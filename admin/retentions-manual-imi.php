...
echo $rowhall['name']; ?>
                            ...
                            <div class="actions">
								...
								<a href="retentions-imi-remisions.php?hall=<? echo $_GET['hall']; ?>" class="btn default blue-stripe">
...
$querymain = "select manualretentions.* from manualretentions".$inner." where manualretentions.type = '1' and hallsretention.hall = '$hall'".$sql; 
$resultmain = mysqli_query($con, $querymain);
$nummain = mysqli_num_rows($resultmain);
$totpagina = ceil($nummain / $tampagina);    

 
$querymain1 = "select hallsretention.* from manualretentions".$inner." where manualretentions.type = '1' and hallsretention.hall = '$hall'".$sql." order by hallsretention.id desc limit ".$inicio.",".$tampagina;
