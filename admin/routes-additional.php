					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Perfiles Adicionales</a></li>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
                             ...
                             <a href="routes-additional-add.php" class="btn default blue-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <div class="note note-regular">
                            ...
                            <strong> Perfiles adicionales</strong>	</p>
...
<div class="row"><!--/span-->
        ...
        <?php //start
                                                        ...
                                                        $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '6' order by routes.type"; 
