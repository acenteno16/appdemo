				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="#">Opciones</a> <i class="fa fa-angle-right"></i></li>
                        ...
                        <li>
							...
							<a href="routes-bd.php">Deuda bancaria</a> <i class="fa fa-angle-right"></i></li>

					  <li>

							<a href="#">Editor de usuarios</a> </li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
                            ...
                            <strong>Confirmación de fondos</strong></p>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-bd-edit-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
                                        <input name="unit" type="hidden" id="unit" value="<?php echo $_GET['unit']; ?>">

										  <div class="form-body">

											<h3 class="form-section">Editor de usuario</h3>
												...
												<div class="row">
													<div class="col-md-8">
													  ...
													  <div class="form-group">
														  ...
														  $queryUser = "select first, last from workers where code = '$row[worker]'";
														  $resultUser = mysqli_query($con, $queryUser);
														  $rowUser = mysqli_fetch_array($resultUser);
														  $routeUserName = $rowUser['first'].' '.$rowUser['last']
														  
														  ?>
											<input type="text" value="<? echo $routeUserName; ?>" class="form-control" readonly>
													 ...
													 <div class="col-md-4">
														<div class="form-group">
															...
															<select class="form-control" name="company" id="company">
																...
																<?
																$querytype = "select * from companies";
