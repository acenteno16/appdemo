		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Rutas  <small>Deuda bancaria</small>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							Usuarios deuda bancaria</div>

							<div class="actions">

                                
                             <a href="routes-bd-add.php" class="btn default blue-stripe">
...
<div class="row"><!--/span-->
        ...
        <?php //start
                                                         $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '13' order by routes.type";  
...
?>
                                ...
                                <tr role="row" class="odd <?php if($red == 1) echo 'newred'; ?>">
								  ...
								  echo $rowtype["name"].' ('.$row['type'].')'; ?></td>
                                  <td><? if($row['type'] == 57){ if($row['company'] > 0) echo $theCompany[$row['company']]; else echo 'En espera'; }else{ echo 'NA'; }?></td>  
                                <td>
                                   <? if($row['type'] == 57){ ?>
									<a href="routes-bd-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-primary">
