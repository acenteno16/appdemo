                	...
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="routes-by-unit-view-add.php?unit=<?php echo $_GET['unit']; ?>" class="btn default blue-stripe">
...
<div class="row"><!--/span-->
 	...
 	<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                                ...
                                <?php $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where routes.unit = '$_GET[unit]' and usertype.type = '1' and routes.headship='0' order by routes.type";
