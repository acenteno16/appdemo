				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="routes-cb.php">Conciliaciones bancarias</a> <i class="fa fa-angle-right"></i></li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
                            ...
                            <strong>Conciliaciones bancarias</strong></p>
...
<?php $querytype = "select * from usertype where type = '11'";
...
<?php } ?>															</select>
       ...
       <input name="referer" type="hidden" id="referer" value="routes-cb.php">
