					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Confirmacion de Fodos</a></li>
                	...
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
                             ...
                             <a href="routes-cdf-add.php" class="btn default blue-stripe">
...
<div class="row"><!--/span-->
        ...
        <?php //start
                                                         $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '10' order by routes.type";  
