		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Rutas <small>Departamentos</small></h3>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="routes-departments.php">Departamentos</a> <i class="fa fa-angle-right"></i></li>
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
							...
							?>
                             ...
                             <strong>Unidades de Negocio:</strong>	<?php $queryname = "select * from units where code2 = '$_GET[unit]' order by code asc";
