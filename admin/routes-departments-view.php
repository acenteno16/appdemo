...
$queryunit = "select * from units where code = '$id'";
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Rutas <small>Departamentos</small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="routes-departments.php">Departamentos</a>
                            <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<?php /*<div class="actions">
								...
								<a href="routes-departments-view-add.php?unit=<?php echo $_GET['unit']; ?>" class="btn default blue-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <div class="note note-<? if($rowunit['active'] == 1) echo 'regular'; else echo 'danger';   ?>">
                            ...
                            <strong>Sucursal:</strong>	<?php echo $_GET['unit']; ?>	<br>
                             <strong>Unidades de Negocio:</strong>	<?php 
							 $queryname = "select * from units where code2 = '$_GET[unit]' order by code asc";
							 $resultname = mysqli_query($con, $queryname);
							 $numname = mysqli_num_rows($resultname);
							 $inc_name = 1;
							 $sql_unit = "";
							 $sql_unit2 = "";
							 $sql_unit.= " and ((routes.unit = '$_GET[unit]')";
							 $sql_unit2.= " and ((unit = '$_GET[unit]')";
							 while($rowname=mysqli_fetch_array($resultname)){
								if($inc_name > 1){
								//$sql_unit.= " or (routes.unit = '$rowname[code]')";
							 }
							 $inc_name++;
							 echo $rowname['code']." ".$rowname["name"].", ";
							 }
							 $sql_unit.= ")"; 
                         ...
                         <div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-departments-view-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
...
<?php 
$querytype = "select * from usertype where type = '1'";
...
<div class="row"><!--/span-->
		...
		$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where routes.unit = '$_GET[unit]' and usertype.type = '1' and routes.headship='0' order by routes.type";
		
		echo $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '1' and routes.headship='0'".$sql_unit." order by routes.type";
...
?>
                                ...
                                <tr role="row" class="odd <?php if($red == 1) echo 'newred'; ?>">
									...
									<td><?php echo $rowworker["code"]." | ".$rowworker["first"]." ".$rowworker["last"]; ?></td><td><?php echo $rowworker["email"]; ?></td>
