							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-edit-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers"> 
...
<div class="col-md-3"> 
<label class="control-label">Monto personalizado</label>
<select name="camount" class="form-control" id="camount">
<option value="0" selected>No</option>
<option value="1" <? if($row['camount'] == 1) echo 'selected'; ?>>Si</option>
 ...
 */ ?>  
                                                   ...
                                                   <? 
												   if($row['type'] == 1){ 
												   $access = explode(",", $row['requestaccess']);
												   ?>
												   <div class="row"></div>
                                                   <div class="col-md-12">
												   ...
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="1" <? foreach($access as $b){ if ($b ==  1) echo "checked";} ?>>
												   <label>Pagos (Tradicionales)</label><br>
												   
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="2" <? foreach($access as $b){ if ($b ==  2) echo "checked";} ?>>
												   <label>Pasantes (Billetera Móvil)</label><br>
												   
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="3" <? foreach($access as $b){ if ($b ==  3) echo "checked";} ?>>
												   <label>Viaticos (Cuenta Bancaria)</label> <br>
												   
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="5" <? foreach($access as $b){ if ($b ==  5) echo "checked";} ?>>
												   <label>Viaticos (Billetera Móvil)</label> <br>
												   
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="4" <? foreach($access as $b){ if ($b ==  4) echo "checked";} ?>>
												   <label>Devoluciones</label> <br>
													   
												   <input name="requestaccess[]" type="checkbox" id="requestaccess[]" value="7" <? foreach($access as $b){ if ($b ==  7) echo "checked";} ?>>
...
*/ ?>
											...
											<div class="form-actions right">
												...
												<button type="button" class="btn default" onClick="javascript:wback();">Cancelar</button>
<script>
function wback(){
	window.location = "<?php echo $_SERVER['HTTP_REFERER']; ?>";
											  ...
											  <button type="submit" class="btn blue"><i class="fa fa-check"></i> Editar</button>
                                                ...
                                                <input name="type" type="hidden" id="type" value="<?php echo $row['type']; ?>"> 
