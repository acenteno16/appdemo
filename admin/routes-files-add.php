									...
									<div class="portlet-body form">
                                        ...
                                        <input name="unit" type="hidden" id="unit" value="<?php echo $_GET['unit']; ?>">
										  ...
										  <div class="form-body">
											...
											<h3 class="form-section">Agregar usuario a la ruta de Archivos</h3>
...
<?php $querytype = "select * from usertype where type = '4'";
...
<?php } ?>															</select>
       ...
       <input name="referer" type="hidden" id="referer" value="routes-files.php">                                                   <input name="id" type="hidden" id="id" value="<?php echo $row['id']; ?>">
                                                        </div>
                                                      </div>
													</div>
