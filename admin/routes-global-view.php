...
<div class="row"><!--/span-->
 	...
 	<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                                ...
                                <?php $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where routes.unit = '$_GET[unit]' and usertype.type = '1' order by routes.type";
