				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="routes-global-releasing.php" class="btn default blue-stripe">

								<i class="fa fa-plus"></i>

								<span class="hidden-480">

								Calibrar Liberadores</span>

								</a>
                                
                             <a href="routes-global-add.php" class="btn default blue-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <div class="note note-regular">
                            ...
                            <strong> Rutas de pago Globales</strong>	</p>
...
<div class="row"><!--/span-->
 	...
 	<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                                ...
                                <?php $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '3' order by routes.type";
