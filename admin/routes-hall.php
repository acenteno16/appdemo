                	...
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="routes-hall-add.php" class="btn default blue-stripe">
...
$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '5' order by routes.type"; 
...
?>
                                  ...
                                  <td><?php $querytype = "select * from companies where id = '$row[company]'";
								  $resulttype = mysqli_query($con, $querytype);
								  $rowtype = mysqli_fetch_array($resulttype);
								  echo $rowtype["name"]; 
								  
								  if($row['company'] == "999999999"){
									  echo "Global";
								  }
								  
								  ?></td>
                                  
                                   <td><?php $querytype = "select * from halls where id = '$row[unit]'";
								  $resulttype = mysqli_query($con, $querytype);
								  $rowtype = mysqli_fetch_array($resulttype);
								  echo $rowtype["name"]; 
                                ...
                                <td>
                                    <a href="routes-hall-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-primary"> 
