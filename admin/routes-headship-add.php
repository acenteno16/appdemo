			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
									<p>
							<?php $queryunit = "select * from units where id = '$_GET[id]'";
							$resultunit = mysqli_query($con, $queryunit);
							$rowunit = mysqli_fetch_array($resultunit);
							?>
                            <strong>Unidad de Negocio:</strong>	<?php echo "$rowunit[newCode] | $rowunit[companyName] $rowunit[lineName] $rowunit[locationName]"; ?>	
							<? if($rowunit['code'] > 0){ ?><br><strong>Referencia:</strong> <? echo $rowunit['code'].' | '.$rowunit['name']; } ?></p>
