...
$id = $_GET['headship'];
$query = "select * from headship where id = '$id'";
$result = mysqli_query($con, $query);
$row = mysqli_fetch_array($result); 

$queryunit = "select * from units where id = '$row[unitid]'";
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Rutas <small>Jefaturas</small></h3>
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="#">Jefaturas</a> <i class="fa fa-angle-right"></i></li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
                            ...
                            <strong>Ruta de Jefaturas</strong>	<br>
                           <strong>Nombre de la Jefatura:</strong> <? echo $row['name']?><br>
<strong>Unidad de Negocios:</strong> <?php echo $rowunit['newCode'].' | '.$rowunit['companyName'].' '.$rowunit['lineName'].' '.$rowunit['locationName']; ?> 	</p> 
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-headship-user-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
                                        <input name="unit" type="hidden" id="unit" value="<?php echo $_GET['unit']; ?>">

										  <div class="form-body">

											<h3 class="form-section">Agregar usuario a Jefatura</h3>
...
<?php echo $querytype = "select * from usertype where type = '1' order by position";
...
<?php } ?>															</select>
                                                        ...
                                                        <div class="form-actions right">
                                                          ...
                                                          <button type="submit" class="btn blue"><i class="fa fa-check"></i> Agregar</button>
															<input name="id" type="hidden" id="id" value="<?php echo $_GET['headship']; ?>"> 
															<input name="unitid" type="hidden" id="unitid" value="<?php echo $row['unitid']; ?>">
                                                        </div>
                                                      </div>
													</div>
