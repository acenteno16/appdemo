			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
                            ...
                            <strong>Ruta de Jefaturas</strong>		</p>
...
<?php echo $querytype = "select * from usertype where headship = '1'";
...
<?php } ?>															</select>
       ...
       <input name="unit" type="hidden" id="unit" value="<?php echo $row['unit']; ?>">                                                   
       <input name="headship" type="hidden" id="headship" value="<?php echo $_GET['id']; ?>">
       
       <input name="referer" type="hidden" id="referer" value="routes-headship-view-detail.php?id=<?php echo $_GET['id']; ?>">                                                   <input name="id" type="hidden" id="id" value="<?php echo $row['id']; ?>">
                                                        </div>
                                                      </div>
													</div>
