			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<li>
							...
							<a href="routes-letters.php">Transferencias Bancarias</a> <i class="fa fa-angle-right"></i></li>

<li><a href="routes-letters.php">Agregar usuario</a></li>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-letters-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
                                        <input name="unit" type="hidden" id="unit" value="<?php echo $_GET['unit']; ?>">

										  <div class="form-body">

											<h3 class="form-section">Agregar usuario a la ruta de Transferencias Bancarias</h3>
...
<?php $querytype = "select * from usertype where type = '7'";
