		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Rutas <small>Transferencias Bancarias</small>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Transferencias Bancarias</a></li>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">	
							Ruta de Transferencias Bancarias</div>

							<div class="actions">

								<a href="routes-letters-add.php" class="btn default blue-stripe">
...
$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '7' order by routes.type";
...
?>
								  ...
								  ?></td>
                                   ...
                                   <td>
                                   <? if($row['type'] == 30){ ?> <a href="routes-letters-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-primary">
