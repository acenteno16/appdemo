			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
                        ...
                        <li><a href="routes-managua.php">Matrices (Managua)</a> <i class="fa fa-angle-right"></i></li>
							...
							<div class="tab-pane" id="tab_1">
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="routes-managua-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
                                        <input name="unit" type="hidden" id="unit" value="<?php echo $_GET['unit']; ?>">

										  <div class="form-body">

											<h3 class="form-section">Agregar ruta</h3>
