			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
                            ...
                            <strong>Unidad de Negocio:</strong>	<?php echo "$row[newCode] | $row[companyName] $row[lineName] $row[locationName]"; ?>	<br>
							<? if($row['code'] > 0){ ?><strong>Referencia:</strong> <? echo "$row[code] | $row[name]"; } ?></p>
								...
								<div class="portlet box blue">
								  ...
								  <div class="portlet-title">
									...
									<div class="portlet-body form">
										...
										<form action="routes-managua-view-add-code.php" method="post" enctype="multipart/form-data" class="horizontal-form" id="providers" onSubmit="return validateForm();"> 
