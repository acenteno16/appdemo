...
$queryunit = "select * from units where id = '$id'";
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="routes-managua.php">Managua</a>
                            <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
			...
			<div class="row">
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="routes-headship-add.php?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
                             ...
                             <? /*<a href="routes-managua-view-add.php?id=<?php echo $_GET['id']; ?>" class="btn default blue-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <div class="note note-<? if($rowunit['active'] == 1) echo 'regular'; else echo 'danger'; ?>">
						  <p>
                            <strong>Unidad de Negocio:</strong>	<? echo $rowunit['newCode'].' | '.$rowunit['companyName'].'/'.$rowunit['lineName'].'/'.$rowunit['locationName']; ?><br>
							<? if($rowunit['name'] != ''){ ?>
							<strong>Código de referencia:</strong> <?php echo $rowunit['code'].' | '.$rowunit['name']; ?>	
						  	<? } ?>
						  </p>
...
<div class="row"><!--/span-->
 ...
 <div class="portlet"><br>
					...
					<? 
					$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where routes.unitid = '$id' and usertype.type = '1' and routes.headship='$rowmain[headship]' order by usertype.position, usertype.id";
...
?>
                                ...
                                <tr role="row" class="odd <?php if($red == 1) echo 'newred'; ?>">
									...
									<td><? echo $rowworker["code"]; ?></td><td><?php echo $rowworker["first"]." ".$rowworker["last"]; ?></td><td><?php echo $rowworker["email"]; ?></td>
...
##?>
	...
	<?php 
	$querymain = "select * from headship where unitid = '$id' and deleted = '0'";
	if($_GET['echo'] == 1){
		echo $querymain;
	}
   ...
   <div class="portlet"><br>
						...
						<?php echo $rowmain['name']." (ID#".$rowmain['id'].")"; ?> 
							...
							<div class="actions">
                             ...
                             <a href="javascript:editRouteName(<?php echo $rowmain['id']; ?>);" class="btn default blue-stripe"> 

								<i class="fa fa-edit"></i> 

								<span class="hidden-480">

								Editar Ruta especial</span>

								</a>
								<script>
								function editRouteName(id){
									var name = prompt("Nombre de la Ruta:", "<? echo $rowmain['name']; ?>");
                                    if((name != '') && (name != null)){
                                        window.location = "routes-headship-name-editor.php?id=<? echo $rowmain['id']; ?>&name="+name;
                                    }
	...
	<? 
	$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where routes.unitid = '$id' and usertype.type = '1' and routes.headship='$rowmain[id]' order by usertype.position, usertype.id";
	if($_GET['echo'] == 1){
		echo $query;
	}
	$result = mysqli_query($con, $query);
