			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="note note-regular">
							...
							?>
                            <strong>Perfiles de reportes</strong></p>
...
<?php $querytype = "select * from usertype where type = '8'";
...
<?php } ?>															</select>
       ...
       <input name="referer" type="hidden" id="referer" value="routes-reports.php">
