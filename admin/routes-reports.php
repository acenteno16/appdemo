					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Perfiles de reportes</a></li>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							Perfiles de reportes</div>

							<div class="actions">

                                
                             <a href="routes-reports-add.php" class="btn default blue-stripe">
...
<div class="row"><!--/span-->
        ...
        <?php //start
                                                         $query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '8' order by routes.type";  
