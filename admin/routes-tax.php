					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">IVA Crédito fiscal</a></li>
				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="caption">	
							Ruta de IVA Crédito fiscal
							</div>

							<div class="actions">

								<a href="routes-tax-edit.php?id=0" class="btn default blue-stripe">
...
$query = "select routes.* from routes inner join usertype on routes.type = usertype.id where usertype.type = '9' order by routes.type"; 
...
?>
                                ...
                                <td>
                                    <a href="routes-tax-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-primary"> 
