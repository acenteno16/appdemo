				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="routes-add.php" class="btn default blue-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					  <div class="note note-info">
									<p>
							<?php $queryunit = "select * from units where id = '$_GET[unit]'";
...
?>
                                ...
                                <td><a href="users-edit.php?id=<?php echo $row['id']; ?>"><span class="label label-warning">
