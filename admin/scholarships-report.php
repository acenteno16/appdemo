...
<div class="col-md-3"> 
<label class="control-label">Etapa (Rango de fechas):</label>
...
<br><br>
						...
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-repeat"></i> Eliminar Filtro</button>
							...
							<script>
							function goBack(){
								window.location = "scholarships-report.php";
							}
							</script>
...
$query1 = "select payments.id, payments.provider, payments.collaborator, payments.btype, payments.currency, payments.payment from payments inner join bills on payments.id = bills.payment".$join." where bills.concept='144'".$sql." group by payments.id limit ".$inicio.",".$tampagina; 
...
if($_GET['echo'] == 1){
	echo '<strong>Query:</strong> '.$query1."<br><strong>Num:</strong> ".$num1."<br><br><br>
"; 
...
echo $numdev; ?> Solicitudes de pagos
							...
							<div class="actions">
								...
								<a href="scholarships-report-excel.php?sql=<? echo $sql; ?>" class="btn default blue-stripe">
