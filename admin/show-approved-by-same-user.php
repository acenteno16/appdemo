...
$querymain = "select payment, userid, today, count(userid) as nr from times where (stage = '2.00' or stage = '3.00' or stage = '4.00')".$sql." group by payment, userid having count(userid) > 1";
...
?> Solicitudes ingresados vencidos de <? echo $nummain; ?> Solicitudes en total.</div>
             ...
             if(checkall.checked == true){ 
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
								...
								$rowapprove = mysqli_fetch_array(mysqli_query($con, "select * from workers where code = '$rowmain[userid]'"));
								
								?>
                                
                                <tr role="row" class="odd <?php if($rowapprove['code'] == 226237) echo 'success';  else echo ' danger' ?>">  <td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                            ...
                            <td><? echo date("d-m-Y", strtotime($rowmain[today]));  ?></td> 
                             
                            <td><? echo $rowapprove['code']." |  ".$rowapprove['first']." ".$rowapprove['last']; ?></td>
                             <td><? echo $rowworker['first']." ".$rowworker['last']; ?></td>
                             <td><a href="payment-order-view.php?id=<? echo $rowmain['payment']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a></td></tr>
                                <?php }
