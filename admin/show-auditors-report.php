		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Auditores</small> 
...
<form id="ungrouped" name="ungrouped" action="show-auditors-report-code.php" enctype="multipart/form-data" method="get">
...
<br><br>
						<div class="col-md-12">							
                            ...
                            <button type="button" class="btn red" onClick="resetFilert();"><i class="fa fa-times"></i> Eliminar filtro</button> 
				            <script>
                            function resetFilert(){
                                window.location = 'show-auditors-report.php';
                            }
                            </script>								
                 </div> 
</div>
