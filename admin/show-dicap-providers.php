		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Proveedores DICAP</small> 
...
<form id="ungrouped" name="ungrouped" action="show-dicap-providers-code.php" enctype="multipart/form-data" method="get">
<input name="form" type="hidden" id="form" value="1">
<div class="note note-regular">
<div class="row">
<h4 style="margin-left:15px;">Reporte de Proveedores DICAP</h4><br>
<?php /*                                           
<?php //Tipo ?>  
<div class="col-md-4">
