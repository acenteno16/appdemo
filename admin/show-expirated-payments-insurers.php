					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Vistas (Ingresos vencidos)</a>
...
$num2 = mysqli_num_rows($result2); 
						...
						?> Solicitudes ingresados vencidos de <? echo $num2; ?> Solicitudes en total.</div>
...
if(($numdev > 0) and ($_GET['form'] == 1)){ 

if(($_GET['form'] == 1) and ($provider == "")){
	echo "<script>alert('Seleccionar un Proveedor'); history.go(-1);</script>";
}

?>   
					
<a href="show-expirated-payments-insurers-excel.php?sql=<? echo $sql; ?>"> [Export excel]</a>     
