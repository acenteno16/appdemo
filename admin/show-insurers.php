		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Aseguradoras</small> 
...
<form id="ungrouped" name="ungrouped" action="show-insurers-code.php" enctype="multipart/form-data" method="post">
...
<div class="col-md-3">
 ...
 <?php $queryproviders = "select id, code, name from providers where insurers = '1' order by name";
...
$querycompany = "select * from banks order by name";
$resultcompany = mysqli_query($con, $querycompany);
while($rowcompany=mysqli_fetch_array($resultcompany)){
?>
<option value="<?php echo $rowcompany['id']; ?>" <?php if($_GET['bank'] == $rowcompany['id']) echo 'selected'; ?>><?php echo $rowcompany['name']; ?></option>
<?php } ?> 
 ...
 <div class="col-md-3 ">
													  <div class="form-group">
                                                        ...
                                                        <input name="tamount" type="text" class="form-control" id="tamount" value="">
...
<div class="col-md-3 ">
			    <div class="form-group">
                  ...
                  <input name="doc" type="text" class="form-control" id="doc" value="">
...
<div class="col-md-3 ">
			    <div class="form-group">
				  <label>PK:</label>
                  <input name="pk" type="text" class="form-control" id="pk" value="">
...
<div class="col-md-3 ">
			    <div class="form-group">
                  ...
                  <input name="ref" type="text" class="form-control" id="ref" value="">
...
<br><br>
						...
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-repeat"></i> Regresar</button>
							...
							<script>
							function goBack(){
								window.location = "show-insurers.php";
							}
							</script>
