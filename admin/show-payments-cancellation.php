...
$query1 = "select payments.* from payments inner join schedulecontent on payments.id = schedulecontent.payment inner join schedule on schedulecontent.schedule = schedule.id where payments.status = '13' and payments.approved != '3' and (schedule.status = '3' or schedule.status = '5') order by payments.expiration desc limit ".$inicio.",".$tampagina;  
$result1 = mysqli_query($con, $query1); 
if($pagina < $totpagina) $next = $pagina+1;
if($pagina > 1) $previous = $pagina-1;	
								
?> Solicitudes en Cancelación</div>

							<div class="actions">

								<a href="show-payments-cancellation-export.php" class="btn default blue-stripe">
