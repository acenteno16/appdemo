...
$query1 = "select * from payments where approved = '1' and sent = '3' and status != '2' and status < 14 order by expiration asc limit ".$inicio.",".$tampagina;  
$result1 = mysqli_query($con, $query1); 
if($pagina < $totpagina) $next = $pagina+1;
if($pagina > 1) $previous = $pagina-1;	
								
?> Solicitudes en Control de Calidad

							</div>

							<div class="actions">

								<a href="show-payments-cc-export.php" class="btn default blue-stripe">
...
if(($rowstatus['stage2'] != "0.00") and ($rowstatus['stage2'] != "")){  
                           ...
                           <td>
                           <? 
	$queryroute = "select workers.code, workers.first, workers.last from workers inner join routes on workers.code = routes.worker where routes.type = '11'";
