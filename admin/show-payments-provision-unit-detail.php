					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="show-payments-provision-unit.php">Provisión</a>
...
$query = "select * from payments where approved = '1' and (status = '2' or status = '3' or status = '4') and child = '0' and route = '$unit' order by expiration desc";
$result = mysqli_query($con, $query);
echo $numdev = mysqli_num_rows($result);
$totpagina = ceil($numdev / $tampagina);       


$query1 = "select * from payments where approved = '1' and (status = '2' or status = '3' or status = '4') and child = '0' and route = '$unit' order by expiration asc limit ".$inicio.",".$tampagina;  
$result1 = mysqli_query($con, $query1); 
if($pagina < $totpagina) $next = $pagina+1;
if($pagina > 1) $previous = $pagina-1;	
								
								?> Solicitudes en Provisión
...
if($numdev > 0){  ?>
                               ...
                               <div class="note note-regular">
                                <? 
	$queryroute = "select workers.code, workers.first, workers.last from workers inner join routes on workers.code = routes.worker where routes.unit = '$unit' and routes.type = '5'";
