		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Provisiones por UN</small> 
...
<form id="payment" name="payment" action="#" enctype="multipart/form-data" method="post"> 
...
<br><br>
						<div class="col-md-12">							
						    ...
						    <button type="button" class="btn blue" onClick="sendForm(2);"><i class="fa fa-file-excel-o"></i> Exportar Excel (UN)</button>
							<button type="button" class="btn blue" onClick="sendForm(1);"><i class="fa fa-file-excel-o"></i> Exportar Excel (Detalle)</button> 
												<script>
												function sendForm(tval){
													if(tval == 1){
														document.forms['payment'].action = "show-payments-provisioned-export-detail.php";
													}
													if(tval == 2){
														document.forms['payment'].action = "show-payments-provisioned-export.php";
													}
						...
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-filter"></i> Limpiar Filtro</button>
                           
							<script>
							function goBack(){
								window.location = "show-payments-requested.php";
							}
							</script>
								...
								<p><br>
**El período máximo a reportar es de 3 meses.</p>
