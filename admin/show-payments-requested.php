		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Soicitudes por UN</small> 
...
<form id="ungrouped" name="ungrouped" action="show-payments-requested-export.php" enctype="multipart/form-data" method="post">
...
<br><br>
						<div class="col-md-2">							
						    ...
						    <input type="hidden" id="form" name="form" value="1"><button type="submit" class="btn blue"><i class="fa fa-file-excel-o"></i> Exportar Excel</button> 
