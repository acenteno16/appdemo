					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#"><span class="caption">Aprobación de Programación</span></a>
...
$query1 = "select payments.* from payments inner join schedulecontent on payments.id = schedulecontent.payment inner join schedule on schedulecontent.schedule = schedule.id where payments.status = '12' and payments.approved != '3' and schedule.vo = '1' order by payments.expiration desc limit ".$inicio.",".$tampagina;  
$result1 = mysqli_query($con, $query1); 
if($pagina < $totpagina) $next = $pagina+1;
if($pagina > 1) $previous = $pagina-1;	
								
?> Solicitudes en Aprobación de Programación</div>

						<div class="actions">

								<a href="show-payments-schedule-approve-export.php" class="btn default blue-stripe">
