...
$query1 = "select * from payments where approved = '1' and (sent_approve = '1' or d_approve = 1) and (status = '9' or status = '13.02' or status = '13.03') order by expiration asc limit ".$inicio.",".$tampagina;  
$result1 = mysqli_query($con, $query1); 
if($pagina < $totpagina) $next = $pagina+1;
if($pagina > 1) $previous = $pagina-1;	
								
?> Solicitudes en Programación
							...
							<div class="actions">
								...
								<a href="?showtable=1" class="btn default blue-stripe">

								<i class="fa fa-table"></i> 

								<span class="hidden-480">

								Mostrar en Pantalla</span>

								</a>
								<a href="show-payments-schedule-export.php" class="btn default blue-stripe">
...
if(($rowstatus['stage2'] != "0.00") and ($rowstatus['stage2'] != "")){  
                           ...
                           <td>
                           <? 
	$queryroute = "select workers.code, workers.first, workers.last from workers inner join routes on workers.code = routes.worker where routes.type = '7'";
                 ...
                 <li>
                  ...
                  <?php } ?>
						...
						<p>
							...
							NOTA: Si desea ver los resultados en pantalla debe de seleccionar "Mostrar en pantalla".
