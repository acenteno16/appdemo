...
<form id="ungrouped" name="ungrouped" action="show-providers-amount-code.php" enctype="multipart/form-data" method="post">
...
<br><br>
						...
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-repeat"></i> Regresar</button>
							...
							<script>
							function goBack(){
								window.location = "show-providers-amount.php";
							}
							</script>
