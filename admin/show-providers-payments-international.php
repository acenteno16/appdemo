		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Proveedores Nac/Internac</small> 
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<a href="#">Proveedores Nac/Internac</a>
...
<form id="ungrouped" name="ungrouped" action="show-providers-payments-international-excel.php" enctype="multipart/form-data" method="post">
...
<option value="1" <?php if($rowbill['type'] == 1){ echo 'selected'; } ?>>Internacional</option>
<option value="2" <?php if($rowbill['type'] == 2){ echo 'selected'; } ?>>Nacional</option>
</select>
</div>
</div>                                            
<?php //Rango de Fechas ?>
