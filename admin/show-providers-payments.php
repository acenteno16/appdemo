		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Reportes <small>Pagos a Proveedores</small> 
...
<form id="ungrouped" name="ungrouped" action="show-providers-payments-code.php" enctype="multipart/form-data" method="post">
...
<br><br>
						...
						<button type="button" class="btn blue" onClick="goBack();"><i class="fa fa-repeat"></i> Regresar</button>
							...
							<script>
							function goBack(){
								window.location = "show-providers-payments.php";
							}
							</script>
								...
								<p>**Se debe de seleccionar un proveedor específico.<br>
