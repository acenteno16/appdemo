...
$querymain1 = "select irretention.payment, irretention.number, irretention.id from irretention inner join payments on irretention.payment = payments.id where irretention.number > '0' and payments.hall = '$hall'".$sql." limit ".$inicio.",".$tampagina; 
