					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample1">
                                ...
                                <td class="sorting_1" id="maintheid"><input name="pid[]" type="checkbox" id="pid[]" value="<?php echo $row['id']; ?>" class="checkboxes"></td>
                                <td><?php echo $row['id']; ?></td><td><?php echo $rowprovider['code']; ?></td><td><?php echo $rowprovider['name']; ?></td><td> <?php $querycurrency = "select * from currency where id = '$row[currency]'";
								...
								?></td><td><?php echo $rowprovider['term']; ?> días</td><td><?php echo $rowstage['content']; ?> 
