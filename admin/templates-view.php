				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							Plantillas de distribución de pagos
									...
									<div class="portlet-body form"> 
										...
										<form action="templates-view-code.php"	 method="post" enctype="multipart/form-data" class="horizontal-form" onsubmit="return validateForm();">  
											...
											<div class="form-body">
												...
												<h3 class="form-section">Plantillas de distribución de gastos</h3>


<?php $querydistribution = "select * from templatescontent where template = '$_GET[id]'";
