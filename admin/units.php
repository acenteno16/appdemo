		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					Unidades de Negocio <small></small></h3>
					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
						...
						<li>
							...
							<a href="#">Unidades de Negocio</a></li>
                   ...
                   <div class="portlet box blue">
                       ...
                       <!--/row-->
											...
											<div class="form-actions right">
												...
												<button type="button" onClick="cleanThis();" class="btn red"><i class="fa fa-trash-o"></i> Limpiar</button> <button type="submit" class="btn blue"><i class="fa fa-check"></i> Buscar</button>
                	...
                	<div class="portlet">
						...
						Seleccionar Unidad de Negocio
                            ...
                            <div class="actions">
								...
								<? if($_GET['viewAll'] == 1){ ?>
								<a href="?viewAll=0" class="btn default blue-stripe">

								<i class="fa fa-eye-slash"></i>

								<span class="hidden-480">

								Ocultar inactivos</span>

								</a>
								<? }else{ ?>
								<a href="?viewAll=1" class="btn default blue-stripe">
								...
								<? } ?>
								<a href="units-add.php" class="btn default blue-stripe">
...
$query = "select * from units where id > 0".$sql." order by code asc";
...
?>
                                ...
                                <tr role="row" class="odd <?php if($row['active'] == 0) echo 'danger'; ?>">
                                  <td class="sorting_1"><?php echo $row["newCode"]; ?></td>
									<td><?php if($row["code"] > 0){ echo $row["code"].' - '.$row["name"]; }else{ echo 'NA'; } ?></td>
									<td><?php echo $row["companyName"]; ?></td>
									<td><?php echo $row["lineName"]; ?></td>
									<td><?php echo $row["locationName"]; ?></td>
                                  <td>
                                     <a href="units-view.php?id=<?php echo $row['id']; ?>">

									 <span class="label label-primary">
									<i class="fa fa-search"> </i> Ver </span></a> <? 
                                       $orSql = "";
                                       if($row['code2'] > 0){
                                            $orSql = "or unit = '$row[code2]'"; 
                                       }
                                       $queryNum = "select id from routes where unit = '$row[code]'$orSql limit 1";
									...
									<i class="fa fa-trash-o"></i>  Eliminar </span></a> */ ?>
                                      <? }
                                       ...
                                       /*
                                      <a href="units-edit.php?id=<?php echo $row['id']; ?>">
