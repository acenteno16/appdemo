									...
									<div class="col-md-3">
										...
										<ul class="list-unstyled profile-nav">
											...
											<li>
												...
												<?php $queryimg = "select * from workers where id = '$id'";
$resultimg = mysqli_query($con, $queryimg);
$rowimg = mysqli_fetch_array($resultimg);

					
					$filepicture = "profiles/".$rowimg['code']."/".$rowimg['code'].".jpg"; 
									...
									<div class="col-md-3">
										...
										<li>
                                            ...
                                            <li>
												...
												<i class="fa fa-lock"></i> Administración </a>

											</li>
											<li>

												<a data-toggle="tab" href="#tab_3-5">
									...
									<div class="col-md-9">
										...
										<div class="tab-content">
											...
											<div id="tab_1-1" class="tab-pane active">
												...
												<form role="form" action="users-edit-code.php" enctype="multipart/form-data" method="post" >
	...
	<div class="col-md-6">												<div class="form-group">
														...
														<input name="code" type="text" class="form-control" id="code" value="<?php echo $row['code']; ?>" readonly/>
<a href="#" id="editCode">[Cambiar]</a>

<script>
document.getElementById('editCode').addEventListener('click', function(e) {
  e.preventDefault();
...
<?php } ?>													  </select> 
													...
													<div class="col-md-6">											<div class="form-group">
														...
														<input name="nid" type="text" class="form-control" id="nid"  value="<?php echo $row['nid']; ?>"/>
											...
											<div id="tab_2-2" class="tab-pane">
												...
												<form action="users-edit-image-upload.php" method="post" enctype="multipart/form-data">
											...
											<div id="tab_3-3" class="tab-pane">
												...
												<form action="users-password-edit.php" method="post" enctype="multipart/form-data">
<input name="id" type="hidden" value="<?php echo $row['id']; ?>">
	...
	<button type="submit" class="btn blue"><i class="fa fa-check"></i> Actualizar</button>
                                            ...
                                            <div id="tab_3-4" class="tab-pane">
												...
												<form action="users-edit-admin.php" method="post" enctype="multipart/form-data">
<input name="id" type="hidden" value="<?php echo $row['id']; ?>">
													<?php /*<div class="form-group">
														...
														<select name="isadmin" class="form-control" id="isadmin">
														  <option value="0" selected>No</option>
       <option value="1" <?php if($row['admin'] == 1) echo 'selected'; ?>>Si</option>    
												  </select>
													</div>
	...
	<button type="submit" class="btn blue"><i class="fa fa-check"></i> Actualizar</button>
											...
											<div id="tab_3-5" class="tab-pane">
											  ...
											  <form action="users-edit-permissions.php" method="post" enctype="multipart/form-data">
												<input name="id" type="hidden" value="<?php echo $row['id']; ?>">
			...
			<div class="col-md-12">
                                                  <p>
                                                      ...
                                                      <br>
                                                      <label>
                                                        <input type="checkbox" name="CheckboxGroup1" value="1" id="CheckboxGroup1_1">
                                                        Pago Urgente</label>
                                                      <br>
                                                </p>
												  </div>
