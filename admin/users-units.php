				...
				<div class="col-md-12">
                	<div class="portlet">
						...
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="users-add-code.php" class="btn default yellow-stripe">
					...
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
					 <div class="note note-info">
									<?php $unitid = $_GET['unit'];
									$queryunit = "select * from units where id = '$unitid'";
									$resultunit = mysqli_query($con, $queryunit);
									$rowunit = mysqli_fetch_array($resultunit);
									?>
                                    <p><strong>Unidad de Negocio:</strong> <?php echo $rowunit['name']; ?><br>
...
<div class="row"><!--/span-->
 	...
 	<table class="table table-striped table-bordered table-hover" id="datatable_orders">
                                ...
                                <?php $query = "select * from routes where unit = '$_GET[unit]'";
...
?>
                                ...
                                <tr role="row" class="odd <?php if($red == 1) echo 'newred'; ?>">
                                  <td class="sorting_1"><?php echo $row["first"]." ".$row["last"]; ?></td><td><?php echo $row["email"]; ?></td>
                                  <td><?php echo $row["sello_cobrador"]; ?></td>
