					...
					<ul class="page-breadcrumb breadcrumb">
					  <li>
                        ...
                        <li>
							...
							<a href="withholding-income-tax.php">IR</a>
                            <i class="fa fa-angle-right"></i>
                            </li>
                        <li>
...
<input type="hidden" id="cbalance" name="cbalance" value="">	
                  ...
                  <div class="col-md-12"><!-- Begin: life time stats -->
                    ...
                    <div class="portlet-body">
                             ...
                             <form action="withholding-income-tax-excel.php" method="post" enctype="multipart/form-data" name="form2" id="form2"><div class="table-container">
...
$query = "select * from ir order by id desc"; 
			   ...
			   checkboxes[i].checked = true;
				 ...
				 checkboxes[i].checked = false;
							   ...
							   $nioammount = $row['ret2a'];	
                                ...
                                <tr role="row" class="odd <?php if($row['deleted'] == 1) echo "danger"; ?>"> <td class="sorting_1" id="maintheid<?php echo $table; ?>"> 
                                  <input name="theid[]" type="checkbox" id="theid[]" value="<?php echo $row['id']; ?>" class="group-checkable" data-set="#datatable_orders .theid" <?php if($row['deleted'] == 1) echo "disabled"; ?>></td>
							...
							</td><td><a href="withholding-income-tax-groups-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable"><i class="fa fa-search"></i> Ver</a>
