...
<br><br>
            	...
            	<form action="withholding-income-tax.php" class="horizontal-form" method="get" enctype="multipart/form-data" >
                                    ...
                                    <a href="withholding-income-tax.php?filter=1">Mostrar filtro</a> 
                                    </div>
									<? } ?>
...
$sql4 = " and scheduletimes.today >= '$from'";
$joinscheduletime = 1;
}
$sql5 = "";
if($_GET['to'] != ""){
...
$sql5 = " and scheduletimes.today <= '$to'";
$joinscheduletime = 1;
}
$sql6 = "";
if($_GET['bill'] != ""){
...
$join2 = "";
if($joinbills == 1){
	$join2 = " inner join bills on payments.id = bills.payment";
}
...
$query = "select payments.* from payments".$join." where scheduletimes.stage = '5.00' and payments.ret2a > '0' and payments.irstage = '1'".$sql." group by payments.id order by ret2id asc";
...
function genExcel(){
	...
	myForm.action = "withholding-income-tax-excel.php";
	myForm.submit();
