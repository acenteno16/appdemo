...
<?php /*<div class="row">
            	...
            	<form action="withholding-mayor-tax.php" class="horizontal-form" method="get" enctype="multipart/form-data" >
...
$query = "select payments.* from payments inner join bills on payments.id = bills.payment inner join hallsretention on payments.id = hallsretention.payment inner join times on payments.id = times.payment where payments.status >= '14' and times.stage='14.00' and payments.mayorstage = '1' and payments.ret1a > '0'".$sql.' group by payments.id order by hallsretention.id asc'; 
								...
								echo $num; ?> Retenciones pendientes

							</div>
                            <div class="actions">

								<a href="withholding-mayor-tax-groups.php" class="btn default blue-stripe">
  ...
  ?>
							...
							</td><td><a href="payment-order-view.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Ver</a> &nbsp; <a href="withholding-mayor-tax-repair.php?id=<?php echo $row['id']; ?>" class="btn btn-xs default btn-editable" target="_blank"><i class="fa fa-search"></i> Reparar</a>
                                ...
                                <div class="form-actions right">
											    ...
											    <?php if(($_GET['mayorstage'] == 0) or (!isset($_GET['mayorstage']))){ ?>	<button type="submit" class="btn blue"><i class="fa fa-check"></i> Solicitar pago</button> <?php } ?> 
               ...
               <?php /*	<div class="col-md-12"><!-- Begin: life time stats -->
					...
					<div class="portlet">
						...
						<div class="portlet-body">
								...
								<?php $query = "select * from payments where status >= '8' and mayorstage = '0' and currency = '2'";
