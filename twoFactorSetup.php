...
<link nonce="<?= $nonce ?>" href="admin/login/css/bootstrap.min.css" rel="stylesheet">
<link nonce="<?= $nonce ?>" href="admin/login/css/font-awesome.min.css" rel="stylesheet">
<link nonce="<?= $nonce ?>" href="admin/login/css/main.css" rel="stylesheet">
<link nonce="<?= $nonce ?>" href="admin/login/css/blue.css" rel="alternatel stylesheet" title="blue">
<style  nonce="<?= $nonce ?>">
	body{
...
<span class="highlight"><img src="images/getpay-white-h.png" data-at2x="images/getpay-white-h.png" alt="logo" width="350"></span></h1>
            ...
            <div class="sub-form">
              <br><br><br><br><br><br><br><br><br>
				...
				<div>Two factor autenticacion:<br>
<!-- Modal (capa flotante) -->
<div id="qrModal" class="modal" >
  ...
  <div class="modal-content" >
    ...
    <h2>Activa la Autenticación de dos Factores</h2>
    <p>Escanea este código QR con tu aplicación Microsoft Authenticator:</p>
    <div class="qr-container">
      <img src="twoFactorQr.php" alt="QR de autenticación" id="qrImage">
    </div>
    <form method="POST" action="verify.php">
      <label for="code">Una vez agregado a tu app, ingresa el código de 6 dígitos:</label>
